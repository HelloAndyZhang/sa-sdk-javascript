export interface SDKConfig {
  ...
  heatmap?: any //	无	点击图配置。默认配置表示不自动采集元素点击事件和页面停留事件，配置成 {} 表示开启 $WebClick 采集 和 $WebStay 自动采集，默认 $WebClick 只采集 a，button，input ，textarea 四个 dom 元素的点击事件。
