!(function (e, t) {
  ...
  function _(e) {
    ...
    if ('function' == typeof window.URL && r())
      ...
      var n = f(e)
      ;(t.hash = n._values.Fragment),
        (t.host = n._values.Host
  ...
  function b(e, t, r, i) {
    ...
    var s = function (e, t, r) {
      if ((void 0 === i && 'click' === t && (i = !0), e && e.addEventListener))
        e.addEventListener(
          t,
          function (e) {
  ...
  function k(e, t, r) {
    ...
    else if (v(e)) for (var i = 0, n = e.length; i < n; i++) i in e && t.call(r, e[i], i, e)
    else for (var a in e) $r.call(e, a) && t.call(r, e[a], a, e)
  }
  function P(e) {
    return (
  ...
  function D(e) {
    ...
    try {
      e.credentials && (n.withCredentials = !0),
        ...
        e.data &&
          (e.cors ||
            (n.setRequestHeader && n.setRequestHeader('X-Requested-With', 'XMLHttpRequest')),
  ...
  function R(e, t) {
    ...
    if (v(i) && i.length >= 2 && !/^(\d+\.)+\d+$/.test(r))
      for (var n = '.' + i.splice(i.length - 1, 1); i.length > 0; )
        if (
          ((n = '.' + i.splice(i.length - 1, 1) + n),
          (document.cookie = t + '=true; path=/; domain=' + n),
          ...
          return (
            ...
            (document.cookie =
              t + '=true; expires=' + a.toGMTString() + '; path=/; SameSite=Lax; domain=' + n),
            n
          )
        }
    return ''
    ...
    if (e.length > 0)
      for (var a = e.split(''), s = 0; s < a.length; s++) {
        var o = a[s].charCodeAt(),
          l = i * n + o
        if (l > t) for (n = r + n; (l = i * n + o), l < r; ) n = n / 2 + o
        if (l < r) for (n = t + n; (l = i * n + o), l > t; ) n = n / 2 + o
        n = i * n + o
      }
    return n
  }
  ...
  function we(e, r, i) {
    ...
    return function () {
      ...
      return (
        ...
        (a = arguments),
        d <= 0 || d > r
          ? (o && (clearTimeout(o), (o = null)), (l = u), (s = e.apply(n, a)), o || (n = a = null))
          : o || i.trailing === !1 || (o = setTimeout(c, d)),
        s
      )
    }
  }
  ...
  function De(e) {
    for (var t, r = [], i = {}, n = 0; n < e.length; n++)
      (t = e[n]), t in i || ((i[t] = !0), r.push(t))
    return r
  }
  function Ce() {
    if (
      ((Ar.isSupport() && 'true' === sessionStorage.getItem('sensorsdata_jssdk_debug')) ||
        Ur.show_log) &&
      (!r(arguments[0]) ||
        (Ur.show_log !== !0 && 'string' !== Ur.show_log && Ur.show_log !== !1) ||
  ...
  function Oe(e) {
    return (
      0 === e.indexOf(Rr)
        ...
        : 0 === e.indexOf(Hr) && ((e = e.substring(Hr.length)), (e = I(e))),
      e
    )
  }
  function je(e) {
  ...
  function xe(e) {
    ...
    return (
      ...
      (i.$element_class_name = 'string' == typeof t.className ? t.className : null),
      (i.$element_target_url = t.getAttribute('href')),
      (i.$element_content = qe(t, r)),
      (i = Ie(i)),
      (i.$url = Z()),
      (i.$url_path = Y()),
    ...
    return (
      ...
      'string' != typeof e
        ...
        : ((e = p(e)),
          ...
          (e = e.slice(0, Ur.max_referrer_string_length)),
          'string' == typeof e ? e : '')
    )
  }
  function Re(e) {
    ...
    for (var i in r) for (var n = r[i], a = 0, s = n.length; a < s; a++) if (n[a].test(t)) return i
    return '\u672a\u77e5\u641c\u7d22\u5f15\u64ce'
  }
  function He(e, t) {
    e = e || document.referrer
    ...
    if (document && 'string' == typeof e) {
      if (0 === e.indexOf('http')) {
        var i = Re(e),
          n = V(e)
        if (se(n))
          return Ur.preset_properties.search_keyword_baidu && Le()
            ? void 0
            : '\u672a\u53d6\u5230\u503c'
        var a = null
        for (var s in r)
          if (i === s && 'object' == typeof n)
            ...
            else if (n[a]) return t ? { active: n[a] } : n[a]
        return Ur.preset_properties.search_keyword_baidu && Le()
          ? void 0
          : '\u672a\u53d6\u5230\u503c'
      }
  ...
  function Be(e) {
    ...
    return (
      d(t) &&
        ...
        d(r) && r.length && (n.hash_key = r),
        d(i) && i.length && (n.callbacks = i)),
      n
    )
  }
  function We() {
  ...
  function Me(e) {
    var t =
      Ur.heatmap && 'function' == typeof Ur.heatmap.collect_input && Ur.heatmap.collect_input(e)
  ...
  function Fe(e, t, i) {
    ...
    return (
      r(Ur.heatmap) && 'undefined' == typeof Ur.heatmap.useCapture && 'click' === t && (n = !0),
      b(e, t, i, n)
    )
  }
  function ze() {
  ...
  function Xe(e, t) {
    ...
    if (((t = t || location.href), Ur.cross_subdomain === !1)) {
      ...
      r =
        'string' == typeof r && '' !== r
          ? 'sajssdk_2015_' + Ur.sdk_id + e + '_' + r.replace(/\./g, '_')
          : 'sajssdk_2015_root_' + Ur.sdk_id + e
  ...
  function et(t) {
    ...
    var a
    ;(a = window.document.documentMode ? 'hashchange' : i ? 'popstate' : 'hashchange'),
      b(window, a, function () {
        t(r), (r = location.href)
      })
  }
  ...
  function rt(e) {
    ...
    r(e.properties) &&
      (e.properties.$first_referrer &&
        (e.properties.$first_referrer_host = W(e.properties.$first_referrer, i)),
      t &&
        ('$referrer' in e.properties &&
          (e.properties.$referrer_host =
            '' === e.properties.$referrer ? '' : W(e.properties.$referrer, i)),
        br.para.preset_properties.latest_referrer &&
          br.para.preset_properties.latest_referrer_host &&
          (e.properties.$latest_referrer_host =
            '' === e.properties.$latest_referrer ? '' : W(e.properties.$latest_referrer, i))))
  }
  function it(e) {
    var t = !e.type || 'profile' !== e.type.slice(0, 7),
  ...
  function nt(e) {
    ...
    'string' == typeof br.para.server_url &&
      ((br.para.server_url = p(br.para.server_url)),
      br.para.server_url &&
    ...
    kr.isSupport() && pe() && 'object' == typeof localStorage
      ? br.para.batch_send === !0
        ? (br.para.batch_send = P({}, a))
        : 'object' == typeof br.para.batch_send &&
          (br.para.batch_send = P({}, a, br.para.batch_send))
    ...
    'object' == typeof br.para.source_type &&
      ...
      (br.para.source_type.keyword = r(br.para.source_type.keyword)
        ? P(c, br.para.source_type.keyword)
        : c))
    var u = { div: !1 },
    ...
    if ((br.para.heatmap && !r(br.para.heatmap) && (br.para.heatmap = {}), r(br.para.heatmap))) {
      ...
      var f = v(br.para.heatmap.track_attr)
        ? J(br.para.heatmap.track_attr, function (e) {
      ...
      if (
        ...
        if (br.para.heatmap.collect_tags.div === !0)
          br.para.heatmap.collect_tags.div = { ignore_tags: d, max_level: 1 }
          ...
          if (
            (br.para.heatmap.collect_tags.div.ignore_tags
              ? v(br.para.heatmap.collect_tags.div.ignore_tags) ||
                ...
                (br.para.heatmap.collect_tags.div.ignore_tags = d))
              : (br.para.heatmap.collect_tags.div.ignore_tags = d),
    ...
    if (v(br.para.server_url) && br.para.server_url.length)
      for (n = 0; n < br.para.server_url.length; n++)
        /sa\.gif[^\/]*$/.test(br.para.server_url[n]) ||
          (br.para.server_url[n] = br.para.server_url[n]
            .replace(/\/sa$/, '/sa.gif')
            .replace(/(\/sa)(\?[^\/]+)$/, '/sa.gif$2'))
    else
  ...
  function ut(t, i) {
    return d(t)
      ? r(window.SensorsDataWebJSSDKPlugin) &&
        ...
        ? (window.SensorsDataWebJSSDKPlugin[t].init(br, i), window.SensorsDataWebJSSDKPlugin[t])
        : r(br.modules) && r(br.modules[t]) && e(br.modules[t].init)
        ? (br.modules[t].init(br, i), br.modules[t])
        : void br.log(
            t +
              '\u6ca1\u6709\u83b7\u53d6\u5230,\u8bf7\u67e5\u9605\u6587\u6863\uff0c\u8c03\u6574' +
              t +
  ...
  function dt(e, t, r) {
    ii.check({ event: e, properties: t }) && ii.send({ type: 'track', event: e, properties: t }, r)
  }
  function pt(e, t) {
    return (
      !!ii.check({ bindKey: e, bindValue: t }) &&
      ((br.store._state.identities[e] = t),
      br.store.save(),
      void ii.send({ type: 'track_id_bind', event: '$BindID', properties: {} }))
    )
  }
  function ft(e, t) {
    if (!ii.check({ unbindKey: e, bindValue: t })) return !1
    if (
    ...
    var n = {}
    ;(n[e] = t),
      ii.send({ identities: n, type: 'track_id_unbind', event: '$UnbindID', properties: {} })
  }
  function _t(e, t, r) {
    function i(e, t, r) {
      function i(e) {
  ...
  function ht(e, t, r) {
    ii.check({ item_type: e, item_id: t, properties: r }) &&
      ii.sendItem({ type: 'item_set', item_type: e, item_id: t, properties: r || {} })
  }
  function mt(e, t) {
    ii.check({ item_type: e, item_id: t }) &&
      ii.sendItem({ type: 'item_delete', item_type: e, item_id: t })
  }
  function vt(e, t) {
    ii.check({ propertiesMust: e }) && ii.send({ type: 'profile_set', properties: e }, t)
  }
  function yt(e, t) {
    ii.check({ propertiesMust: e }) && ii.send({ type: 'profile_set_once', properties: e }, t)
  }
  function bt(e, t) {
    ii.check({ propertiesMust: e }) &&
      (k(e, function (t, r) {
        d(t)
          ? (e[r] = [t])
          : v(t)
      ...
      se(e) || ii.send({ type: 'profile_append', properties: e }, t))
  }
  function St(e, t) {
    function r(e) {
      for (var t in e)
    ...
    d(e) && ((e = {}), (e[i] = 1)),
      ii.check({ propertiesMust: e }) &&
        (r(e)
          ? ii.send({ type: 'profile_increment', properties: e }, t)
          : br.log('profile_increment\u7684\u503c\u53ea\u80fd\u662f\u6570\u5b57'))
  }
  function wt(e) {
    ii.send({ type: 'profile_delete' }, e), Gr.set('distinct_id', Dr()), Gr.set('first_id', '')
  }
  function kt(e, t) {
    var r = e,
      i = {}
    d(e) && ((e = []), e.push(r)),
      v(e)
        ? (k(e, function (e) {
          ...
          ii.send({ type: 'profile_unset', properties: i }, t))
  ...
  function Pt(e, t) {
    ...
    } else ii.check({ distinct_id: e }) && (t === !0 ? (i ? Gr.set('first_id', e) : Gr.set('distinct_id', e)) : i ? Gr.change('first_id', e) : Gr.change('distinct_id', e), r(e))
  }
  function Dt(e, t, r, i) {
  ...
  function Ct(e, t, r, i) {
    'number' == typeof e && (e = String(e)),
      ii.check({ distinct_id: e, event: t, properties: r }) && Dt(e, t, r, i)
  }
  function Ot(e) {
    ii.check({ properties: e })
      ? P(zr.currentProps, e)
  ...
  function $t(e) {
    ...
    if (v(e) && e.length > 0)
      for (t = 0; t < e.length; t++)
        d(e[t]) && e[t] in zr.currentProps && delete zr.currentProps[e[t]]
  ...
  function xt(e) {
    ...
    if (!ii.check({ distinct_id: t })) return br.log('login id is invalid'), !1
    if (t === br.store.getOriginDistinctId() && !a)
      return br.log('login id is equal to distinct_id'), !1
    if (
      r(br.store._state.identities) &&
      br.store._state.identities.hasOwnProperty(n) &&
      t === br.store._state.first_id
    )
      return !1
    var o =
      br.store._state.history_login_id.name !== n || t !== br.store._state.history_login_id.value
    if (o) {
      ;(br.store._state.identities[n] = t),
        br.store.set('history_login_id', { name: n, value: t }),
        a || Gr.set('first_id', s),
        Dt(t, '$SignUp', {}, i)
  ...
  function Lt(t, r) {
    ...
    var i = xt({ id: t, callback: r, name: Vr.LOGIN })
    !i && e(r) && r()
  }
  function Et(e, t) {
    return (
      'number' == typeof t && (t = String(t)),
      'number' == typeof e && (e = String(e)),
      !!ii.check({ loginIdKey: e }) &&
        (Vr.LOGIN === e ? (Lt(t), !1) : void xt({ id: t, callback: null, name: e }))
    )
  }
  function Jt(e) {
    var t = Gr.getFirstId()
  ...
  function Ut() {
    ...
    return (
      br.para.preset_properties.latest_referrer &&
        br.para.preset_properties.latest_referrer_host &&
        (r.$latest_referrer_host = '' === r.$latest_referrer ? '' : W(r.$latest_referrer)),
      r
    )
  }
  function Kt() {
      ...
      (window.sensorsdata_app_call_js.modules[this.type] = function (e) {
        try {
          ...
          if (n && t.resultCbs[n]) {
            ...
            if (t.resultCbs[n]) {
              ;(t.resultCbs[n].result = e),
                clearTimeout(t.timerId),
                (t.timeoutCbs[n].callbacks.length = 0)
              for (var a in t.resultCbs[n].callbacks)
                t.resultCbs[n].callbacks[a].call(null, e), t.resultCbs[n].callbacks.splice(a, 1)
            }
            return
          }
  ...
  function Gt(e) {
    function t() {
      var e = []
      i.touch_app_bridge || e.push(br.debug.defineMode('1')),
        r(br.para.app_js_bridge) || (e.push(br.debug.defineMode('2')), (i.verify_success = !1)),
        (r(br.para.heatmap) && 'default' == br.para.heatmap.clickmap) ||
          e.push(br.debug.defineMode('3')),
        'fail' === i.verify_success && e.push(br.debug.defineMode('4')),
  ...
  function Qt() {
    br.para.is_track_single_page &&
      oi.on('switch', function (e) {
        var t = function (t) {
          ;(t = t || {}),
            e !== location.href &&
              ((zr.pageProp.referrer = Z(e)),
              br.quick('autoTrack', P({ $url: Z(), $referrer: Z(e) }, t)))
        }
  ...
  function rr() {
    Ti.isSeachHasKeyword()
      ? Ti.hasKeywordHandle()
      : window.parent !== self && Ii.isSearchHasKeyword()
      ? Ii.verifyVtrackMode()
      : Ti.isWindowNameHasKeyword()
      ? Ti.windowNameHasKeywordHandle()
      : Ti.isStorageHasKeyword()
      ? Ti.storageHasKeywordHandle()
      : window.parent !== self && Ii.isStorageHasKeyword()
      ? Ii.verifyVtrackMode()
      : (tr(), Ii.notifyUser())
  }
  function ir() {
  ...
  function or(e) {
    e && e.dataStage && Ei.registerStageImplementation(e.dataStage),
      e && e.businessStage && Ri.registerStageImplementation(e.businessStage),
      e && e.sendStage && Ui.registerStageImplementation(e.sendStage)
  }
  function lr(e, t) {
    Hi[e] && Hi[e](t)
  }
  ...
  function mr(e) {
    var t = e.properties
    r(t) ? (ur(t), pr(t), _r(e), hr(t), fr(t)) : 'properties' in e && (e.properties = {}),
      ye(e),
      gr(e)
  }
  function vr() {
  ...
  ;(function () {
    function e(i, n) {
      ...
      if ('object' == typeof g && g)
        return (n.stringify = g.stringify), (n.parse = g.parse), (n.runInContext = e), n
      var h,
        m = u.prototype,
        v = m.toString,
        y = m.hasOwnProperty,
      ...
      if (
              ...
              s
                ? (j = function (e, t) {
                    var r,
                      ...
                      n = v.call(e) == S
                    for (r in e)
                      (n && 'prototype' == r) || !y.call(e, r) || (i = 'constructor' === r) || t(r)
            ...
            var x = '\\u00',
              ...
              U = function (e, t, r, i, n, s, o) {
                ...
                if (
                  ...
                  'object' == typeof l &&
                    l &&
                    (l.getUTCFullYear && v.call(l) == w && l.toJSON === d.prototype.toJSON
                      ? (l = I(l))
                ...
                if ('object' == typeof l) {
                  ...
                  if ((o.push(l), (p = []), (y = s), (s += n), u == D)) {
                    for (g = 0, m = l.length; g < m; g++)
                      (_ = U(g, l, r, i, n, s, o)), p.push(_ === h ? 'null' : _)
                    b = p.length
                      ? n
                        ? '[\n' + s + p.join(',\n' + s) + '\n' + y + ']'
                        : '[' + p.join(',') + ']'
        ...
        if (!s('json-parse')) {
          var K,
            ...
            M = function () {
              for (var e, t, r, i, n, a = R, s = a.length; K < s; )
                switch ((n = a.charCodeAt(K))) {
                  case 9:
                  case 10:
                  case 13:
                  case 32:
                  ...
                  case 34:
                    for (e = '@', K++; K < s; )
                      if (((n = a.charCodeAt(K)), n < 32)) W()
                        ...
                        if (34 == n) break
                        for (n = a.charCodeAt(K), t = K; n >= 32 && 92 != n && 34 != n; )
                          n = a.charCodeAt(++K)
                        e += a.slice(t, K)
                      }
                  ...
                  default:
                    if (
                      ((t = K), 45 == n && ((i = !0), (n = a.charCodeAt(++K))), n >= 48 && n <= 57)
                    ) {
                      for (
                        48 == n && ((n = a.charCodeAt(K + 1)), n >= 48 && n <= 57) && W(), i = !1;
                        K < s && ((n = a.charCodeAt(K)), n >= 48 && n <= 57);
                        K++
                      );
                      ...
                      if (((n = a.charCodeAt(K)), 101 == n || 69 == n)) {
                        for (
                          n = a.charCodeAt(++K), (43 != n && 45 != n) || K++, r = K;
                          r < s && ((n = a.charCodeAt(r)), !(n < 48 || n > 57));
                          r++
                        );
                        r == K && W(), (K = r)
                      }
            ...
            F = function (e, t, r) {
              ...
              if ('object' == typeof n && n)
                if (v.call(n) == D) for (i = n.length; i--; ) V(v, j, n, i, r)
                else
                  j(n, function (e) {
                    V(n, e, r)
                  })
  ...
  ;(a.prototype.get = function (e, r, a, s) {
    ...
    var o = this.lockGetPrefix + e,
      l = kr.get(o),
      c = String(i())
    return l && ((l = n(l) || { randomNum: 0, expireTime: 0 }), l.expireTime > t())
      ? s(null)
      : (kr.set(o, JSON.stringify({ randomNum: c, expireTime: t() + r })),
        void setTimeout(function () {
          ;(l = n(kr.get(o)) || { randomNum: 0, expireTime: 0 }),
    ...
    (a.prototype.set = function (e, r, a, s, o) {
      ...
      var l = this.lockSetPrefix + e,
        c = kr.get(l),
        u = String(i())
      return c && ((c = n(c) || { randomNum: 0, expireTime: 0 }), c.expireTime > t())
        ? o({ status: 'fail', reason: 'This key is locked' })
        : (kr.set(l, JSON.stringify({ randomNum: u, expireTime: t() + a })),
          void setTimeout(function () {
            ;(c = n(kr.get(l)) || { randomNum: 0, expireTime: 0 }),
              c.randomNum === u
      ...
      var e = function () {
        ...
        r = function () {
          ...
          for (t = 0; t < i.length; t++)
            (r = i.charCodeAt(t)), n.unshift(255 & r), n.length >= 4 && ((a = e(a, n)), (n = []))
  ...
  Cr.prototype = {
    ...
    getSameTypeSiblings: function () {
      for (
        var e = this.ele, t = e.parentNode, r = e.tagName.toLowerCase(), i = [], n = 0;
        n < t.children.length;
        n++
      ) {
        var a = t.children[n]
  ...
  var jr = Array.prototype.forEach,
    ...
    Tr = {
      ...
      set: function (e, t, r, i, n, a, s) {
        ...
        e && (_ = o(e)),
          t && (g = o(t)),
          l && (h = o(l)),
          _ && g && (document.cookie = _ + '=' + encodeURIComponent(g) + c + '; path=/' + h + p + u)
      },
      remove: function (e, t) {
        this.set(e, '1', -1, t)
      },
    ...
    Br = {
      ...
      protocol: {
        ...
        serverUrl: function () {
          d(Ur.server_url) &&
            '' !== Ur.server_url &&
            !this.protocolIsSame(Ur.server_url, location.href) &&
            Ce(
    ...
    Vr = { EMAIL: '$identity_email', MOBILE: '$identity_mobile', LOGIN: '$identity_login_id' },
    Fr = {
      data: {},
      id: function () {
    ...
    zr = {
      initPage: function () {
        var e = Ke(),
          t = Z(),
          r = Ae(t)
        r || Br.jssdkDebug('url_domain\u5f02\u5e38_' + t + '_' + r),
          (this.pageProp = {
            referrer: e,
            referrer_host: e ? W(e) : '',
            url: t,
  ...
  var Zr = {
      ...
      set: function (e, t, r) {
        if (r) {
          ...
          ;(i =
            ...
            (t = { value: t, _expirationTimestamp_: i })
        }
        this.data[e] = t
      },
    ...
    Yr = {
      ...
      setDeviceId: function (e) {
        ...
        r = je(r)
        var i = {}
        null != r && ce(r) && ((i = JSON.parse(r)), i.$device_id && (t = i.$device_id)),
          (t = t || e),
          br.para.cross_subdomain === !0
            ? br.store.set('$device_id', t)
            : ((i.$device_id = t),
              (i = JSON.stringify(i)),
              br.para.encrypt_cookie && (i = $e(i)),
              Xr.set('sensorsdata2015jssdkcross' + br.para.sdk_id, i, null, !0)),
          ...
          (br.para.preset_properties.search_keyword_baidu
            ? Ue(document.referrer) &&
              (!Le() || (r(i) && i.active)
                ...
                : ((t.$search_keyword_id = Fr.id()),
                  (t.$search_keyword_id_type = Fr.type()),
            ...
            : br.store._state &&
              ...
              br.store._state.props.$search_keyword_id_hash &&
                delete br.store._state.props.$search_keyword_id_hash),
          br.store.save(),
          k(br.para.preset_properties, function (i, n) {
            ...
            if (((n = n.slice(7)), i)) {
              ...
              br.store._state &&
              br.store._state.props &&
              '$latest_' + n in br.store._state.props
            )
              delete br.store._state.props['$latest_' + n]
            else if (
              'wx_ad_click_id' == n &&
              br.store._state &&
              br.store._state.props &&
    ...
    Gr = {
      ...
      setProps: function (e, t) {
        ...
        for (var i in r)
          'string' == typeof r[i] && (r[i] = r[i].slice(0, br.para.max_referrer_string_length))
        this.set('props', r)
      },
      ...
      init: function () {
        function e(e) {
          ...
          e.identities &&
            (0 === e.identities.indexOf('\n/')
              ? (e.identities = n(ve(e.identities)))
          ...
          e.identities && r(e.identities) && !se(e.identities)
            ...
            : ((e.identities = {}),
              (e.identities.$identity_anonymous_id = i.anonymous_id),
              (e.identities.$identity_cookie_id = Dr())),
        ...
        var i,
          a,
          s = Dr()
        Xr.isSupport() && ((i = Xr.get(this.getCookieName())), (i = je(i)), (a = n(i))),
          Xr.isSupport() && null !== i && ce(i) && r(a) && (!r(a) || a.distinct_id)
            ? ((br.store._state = P(e(a))), br.store.save())
    ...
    ti = {
      distinct_id: {
        ...
        onComplete: function (t, r, i) {
          return (
            (!t && ('emptyString' === i && (r = 'Id'), e(Qr[i]) && Qr[i](r), 'idLength' === i)) || t
          )
        }
      },
      event: {
      ...
      bindKey: {
        ...
        onComplete: function (t, r, i) {
          return (
            (!t && ('emptyString' === i && (r = 'Key'), e(Qr[i]) && Qr[i](r), 'keyLength' === i)) ||
            t
          )
        }
      },
      ...
      bindValue: {
        ...
        onComplete: function (t, r, i) {
          return (
            (!t &&
              ('emptyString' === i && (r = 'Value'), e(Qr[i]) && Qr[i](r), 'idLength' === i)) ||
            t
          )
        }
      },
  ...
  var ni = { label: !1, li: !1, a: !0, button: !0 },
    ai = {
      otherTags: [],
      ...
      getElementPosition: function (e, t, r) {
        function i(e) {
          ...
          for (
            ...
            a = y(a).previousElementSibling().ele, n++
          );
          return n
        }
      ...
      getEleDetail: function (e) {
        ...
        var i = br.heatmap.getElementPosition(
          e,
          r.$element_path,
          br.para.heatmap && 'not_use_id' === br.para.heatmap.element_selector
        )
      ...
      start: function (t, i, n, a, s) {
        ...
        if (
          ...
          !br.para.heatmap.collect_element(i)
        )
          return !1
        ...
        ;(c = P(c, this.getPointerEventProp(t, i), o)),
          'a' === n && br.para.heatmap && br.para.heatmap.isTrackLink === !0
            ? br.trackLink({ event: t, target: i }, '$WebClick', c)
        ...
        var i = function (e) {
          ...
          n = i({
            ...
            func: function (e, t) {
              ...
              ;((n > br.para.heatmap.scroll_delay_time && r - e.$viewport_position !== 0) || t) &&
                ((e.$url = Z()),
            ...
            : Fe(document, 'click', function (e) {
                ...
                s
                  ...
                  : g(a) &&
                    ...
                    t.start(n, a, a.tagName.toLowerCase(), { $lib_method: 'vtrack' })
              })))
        )
      }
    },
    si = {
      ...
      autoTrackSinglePage: function (e, t) {
        ...
        function n(e, t) {
          br.track(
            '$pageview',
            P({ $referrer: a, $url: Z(), $url_path: Y(), $title: document.title }, e, i()),
            t
          ),
            (a = Z())
        }
        ...
        if (
          ...
          br.para.preset_properties.search_keyword_baidu &&
            Ue(document.referrer) &&
            Le() &&
            ((o.$search_keyword_id = Fr.id()),
            (o.$search_keyword_id_type = Fr.type()),
        ...
        if (
          (br.para.is_single_page &&
            S(function () {
              ...
              br.track(
                '$pageview',
                P({ $referrer: r, $url: Z(), $url_path: Y(), $title: document.title }, n, e),
                t
              ),
                (s = Z())
            }),
          br.track(
            '$pageview',
            P({ $referrer: Ke(null, !0), $url: Z(), $url_path: Y(), $title: document.title }, n, e),
            t
          ),
      ...
      setPlugin: function (t) {
        return (
          ...
          void k(t, function (t, i) {
            e(t) &&
              (r(window.SensorsDataWebJSSDKPlugin) && window.SensorsDataWebJSSDKPlugin[i]
  ...
  ;(gi.buildData = function (e) {
    ...
    return (
      r(e) && r(e.identities) && !se(e.identities)
        ? P(t.identities, e.identities)
        : P(t.identities, Gr._state.identities),
      r(e) &&
        r(e.properties) &&
        !se(e.properties) &&
      ...
      P(t, br.store.getUnionId(), e),
      Ge(t),
      r(e.properties) && !se(e.properties) && P(t.properties, e.properties),
      (e.type && 'profile' === e.type.slice(0, 7)) ||
        ...
        'not_collect' === br.para.preset_properties.latest_wx_ad_click_id
          ...
          : br.para.preset_properties.latest_wx_ad_click_id &&
            !d(t.properties._latest_wx_ad_click_id) &&
        ...
        d(t.properties._latest_wx_ad_click_id) && (t.properties.$url = Z())),
      t.properties.$time && A(t.properties.$time)
  ...
  var hi = function (e) {
    ;(this.callback = e.callback),
      ...
      (this.data = e.data),
      (this.server_url = Ht(e.server_url, e.data))
  }
              ...
              ? r.para.app_js_bridge.is_mui
                ? r.para.app_js_bridge.is_mui
                  ? window.plus && window.plus.SDAnalytics && window.plus.SDAnalytics.trackH5Event
                    ? (window.plus.SDAnalytics.trackH5Event(e), r._.isFunction(i) && i(), e)
  ...
  ;(bi.getSendCall = function (e, t, r) {
    ...
    ;(e._track_id = Number(
      String(i()).slice(2, 5) + String(i()).slice(2, 4) + String(new Date().getTime()).slice(-4)
    )),
    ...
    (bi.sendCall = function (e, t, i) {
      ...
      r(br.para.jsapp) && !br.para.jsapp.isOnline && 'function' == typeof br.para.jsapp.setData
        ? (delete n.callback, (n = JSON.stringify(n)), br.para.jsapp.setData(n))
        : this.realtimeSend(n)
    }),
  ...
  Vt.prototype = {
    ...
    getServerUrl: function () {
      return (d(br.para.server_url) && '' !== br.para.server_url) ||
    ...
    send: function () {
      if (!(this.sendTimeStamp && t() - this.sendTimeStamp < br.para.batch_send.datasend_timeout)) {
        ...
        if (
          e &&
          ((this.sendTimeStamp = t()), (e = n(e) || this.generateTabStorageVal()), e.data.length)
        ) {
    ...
    updateExpireTime: function () {
      var e = kr.get(this.tabKey)
      e &&
        ((e = n(e) || this.generateTabStorageVal()),
    ...
    add: function (e) {
      ...
      null === a
        ? ((this.tabKey = wi + String(i())), (a = this.generateTabStorageVal()))
    ...
    recycle: function () {
      for (var e = {}, r = 1e4, i = 'sajssdk-lock-get-', s = 0; s < localStorage.length; s++) {
        var o = localStorage.key(s),
          l = this
        if (0 === o.indexOf(wi)) {
          for (var c = n(kr.get(o)) || this.generateTabStorageVal(), u = 0; u < c.data.length; u++)
            e[c.data[u]] = !0
                ...
                kr.set(
                  ...
                  JSON.stringify(
                    l.generateTabStorageVal(
                      (n(kr.get(l.tabKey)) || this.generateTabStorageVal()).data.concat(t.data)
                    )
                  )
                )
              }
      ...
      app_js_bridge_v1: function () {
        ...
        function t() {
          'object' == typeof window.SensorsData_APP_JS_Bridge &&
            ...
            ((i = SensorsData_APP_JS_Bridge.sensorsdata_call_app()), ce(i) && (i = JSON.parse(i)))
        }
        function r() {
    ...
    return (
      t &&
        (this.timerId = setTimeout(function () {
          ...
          for (var e in r.timeoutCbs[n].callbacks)
            r.timeoutCbs[n].callbacks[e].call(null), r.timeoutCbs[n].callbacks.splice(e, 1)
        }, t)),
      zt(a),
      {
        onResult: function (e) {
          return r.resultCbs[n].result
            ...
            : (!r.timeoutCbs[n].isTimeout && r.resultCbs[n].callbacks.push(e), this)
        },
    ...
    (Di.configIsMatch = function (e, t) {
      return (
        ...
        (t.element_field && t['function']
          ? Di.configIsMatchNew(e, t)
          : Di.configIsMatchOldVersion(e, t))
      )
    }),
        ...
        '$WebClick' === e.event &&
          k(t, function (t) {
            r(t) &&
              ...
              Di.configIsMatch(e.properties, t.event) &&
              n.push(t)
          }),
        n
      )
  ...
  var Ci = {
      ...
      isTargetEle: function (e) {
        ...
        for (var i = 0; i < this.events.length; i++)
          if (
            ...
            br.vtrackcollect.configIsMatch(t, this.events[i].event)
          )
            return !0
        return !1
      }
        ...
        var e = this,
          t = function (t, i) {
            ...
            200 === t
              ...
              : 304 === t
              ? (n = e.config)
              : (br.log('----vtrackcustom----\u6570\u636e\u5f02\u5e38', t), e.updateConfig(n)),
              e.updateStorage(n),
              e.setNextFetch()
          },
          i = function (t) {
      ...
      initAppGetPropsBridge: function () {
        ...
        return (
          t.onAppNotify(function (i) {
            ...
            return 'android' === l && t.notifyApp({ data: n }, i.message_id), n
          }),
          t
        )
      }
    ...
    Ii = {
      ...
      messageListener: function (e) {
        ...
        if ('v-track-mode' === e.data.type) {
          if (e.data.data && e.data.data.isVtrack)
            if (
              (Ar.isSupport() && sessionStorage.setItem('sensors-visual-mode', 'true'),
      ...
      verifyVtrackMode: function () {
        window.addEventListener && window.addEventListener('message', Ii.messageListener, !1),
          Ii.postMessage()
      },
  ...
  ;(sr.prototype.process = function (e, t) {
    ...
    if (r && v(r) && r.length > 0)
      for (var i = { current: 0, total: r.length }, n = new ar(t, i, br), a = 0; a < r.length; a++)
        try {
          if (
            ((i.current = a + 1),
            (t = r[a].call(null, t, n) || t),
  ...
  var Li = { addCustomProps: null, formatData: null },
    Ei = new sr(Li),
    Ji = { beforeSend: 'send', send: 'afterSend', afterSend: null },
    Ui = new sr(Ji),
    Ki = { getUtmData: null },
    Ri = new sr(Ki),
    Hi = {
  ...
  ;(br.init = function (e) {
    return (
      ...
      !(br.readyState && br.readyState.state && br.readyState.state >= 2) &&
        ...
        br.initPara(e),
        ci.sdk.emit('afterInitPara'),
        br.detectMode(),
        br.iOSWebClickPolyfill(),
        void ci.sdk.emit('afterInit'))
    )
  }),
    Mi ? yr(!1) : (yr(!0), ir())
  var qi = br
    ...
    ;(br.modules = {}),
              ...
              function n() {
                return (
                  ...
                  !!e.localStorage.isSupport() &&
                    ...
                    a.eventList.init(),
                    a.addLatestChannelUrl(),
                    void a.addIsChannelCallbackEvent())
                )
              }
              if (t || !i) return !1
              t = i
              ...
              t.registerPage({
                $is_channel_callback_event: function (e) {
                  if (
                    ...
                    return !i.eventList.hasEvent(e.event) && (i.eventList.add(e.event), !0)
                }
              })
            },
                ...
                if (t && e.isNumber(t.latest_event_initial_time) && e.isArray(t.eventList)) {
                  ...
                  n > 0 && n < i.max_save_time
                    ? ((i.event_list = t.eventList),
                      (i.latest_event_initial_time = t.latest_event_initial_time))
                    : this.reset()
                } else this.reset()
              },
              get: function () {
        ...
        var i = { android: /Android/i, iOS: /iPhone|iPad|iPod/i },
          ...
          p = {
            ...
            init: function () {
              ...
              if (
                (o(sensorsDataAnalytic201505) && (this.sd = sensorsDataAnalytic201505),
                this.log('init()'),
                null === this.sd)
              )
              ...
              if (!r)
                return this.log('\u5f53\u524d\u9875\u9762\u7f3a\u5c11deeplink\u53c2\u6570'), !1
              ...
              if ('iOS' === a) {
                ...
                var e =
                  ...
                  this.data.ios_info.ios_wake_url
                    ...
                    : this.data.ios_info.url_schemes
                this.log('\u5524\u8d77APP\u7684\u5730\u5740\uff1a' + e),
                  d(this, e, this.data.ios_info.download_url)
              } else
        ...
        return (
          o(window.SensorsDataWebJSSDKPlugin)
            ? ((window.SensorsDataWebJSSDKPlugin.Deeplink =
                window.SensorsDataWebJSSDKPlugin.Deeplink || p),
              (window.SensorsDataWebJSSDKPlugin.deeplink =
                window.SensorsDataWebJSSDKPlugin.deeplink || p))
            : (window.SensorsDataWebJSSDKPlugin = { Deeplink: p, deeplink: p }),
          p
        )
      })()),
        ...
        ;(e.prototype.init = function (e, t) {
          if (e) {
            ...
            ;(this.page_id = Number(
              ...
              r.addEventListener(),
              document.hidden === !0 ? (this.page_show_status = !1) : r.addHeartBeatInterval(),
          ...
          (e.prototype.saveHeartBeatData = function (e) {
            ...
            var i = this.sd.kit.buildData({ type: 'track', event: '$WebPageLeave', properties: t })
            try {
          ...
          (e.prototype.getPageLeaveProperties = function () {
            ...
            return (
              0 !== e && (i.event_duration = e), (i = this._.extend(i, this.option.custom_props))
            )
          })
        var r = new e()
        return (
          ...
          init: function (e) {
            function t(t, r) {
              if (t.getEntries && 'function' == typeof t.getEntries) {
                for (var i = t.getEntries(), n = null, a = 0; a < i.length; a++)
                  'transferSize' in i[a] && (n += i[a].transferSize)
                e._.isNumber(n) &&
                  n >= 0 &&
                  n < 10737418240 &&
            ...
            function r() {
              ...
              if (i && i.timing) {
                var s = i.timing
                0 === s.fetchStart || 0 === s.domContentLoadedEventEnd
                  ? e.log('performance \u6570\u636e\u83b7\u53d6\u5f02\u5e38')
                  : (n = s.domContentLoadedEventEnd - s.fetchStart),
                  t(i, a)
              } else e.log('\u6d4f\u89c8\u5668\u672a\u652f\u6301 performance API.')
              n > 0 && (a.event_duration = Number((n / 1e3).toFixed(3))),
                e.track('$WebPageLoad', a),
      ...
      (br.modules.RegisterProperties = (function () {
        ...
        ;(t.prototype.init = function () {}),
          (i.prototype.init = function (e) {
            e
              ? ((this.sd = e), (this._ = e._), (this.log = e.log), e.registerFeature(new r(this)))
        ...
        return (
          ...
          '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
            ? (window.SensorsDataWebJSSDKPlugin.RegisterPropertyPageHeight =
                window.SensorsDataWebJSSDKPlugin.RegisterPropertyPageHeight || n)
            : (window.SensorsDataWebJSSDKPlugin = { RegisterPropertyPageHeight: n }),
          n
        )
      })()),
      (function () {
        ...
        ;(e.getPart = function (e) {
          ...
          if (r) for (var i = 0; i < r; i++) if (e.indexOf(this.option[i].part_url) > -1) return !0
          return t
        }),
          ...
          (e.getCurrenId = function () {
            ...
            this._.urlSafeBase64 && this._.urlSafeBase64.encode
              ? (e = e
                  ? this._.urlSafeBase64.trim(this._.urlSafeBase64.encode(this._.base64Encode(e)))
                  : '')
            ...
            if (i) {
              ...
              if (this.getPartHash(e)) {
                ...
                n =
                  c > -1
                    ? a > -1
                      ? s + o + '#' + l.substring(1, a) + '_sasdk=' + this.getCurrenId()
                ...
                n = u
                  ? a > -1
                    ? s + '?' + o.substring(1, a) + '_sasdk=' + this.getCurrenId() + l
              ...
              return (
                !t ||
                  ...
                  this._.urlSafeBase64.isUrlSafeBase64(t)
                    ? (t =
                        t.substring(0, 1) +
                        this._.base64Decode(this._.urlSafeBase64.decode(t.substring(1))))
                    : this._.rot13defs &&
          ...
          (e.init = function (e, t) {
            function r(t) {
              for (var r = t.length, i = [], n = 0; n < r; n++)
                ...
                '[object Boolean]' == Object.prototype.toString.call(t[n].after_hash)
                  ? i.push(t[n])
                  : e.log(
                      'linker \u914d\u7f6e\u7684\u7b2c ' +
                        (n + 1) +
      ...
      (br.modules.AndroidBridge = (function () {
        ...
        function i() {
          if (
            ...
            c.registerInterceptor('sendStage', { send: { priority: 0, entry: n } }),
        ...
        var s,
          ...
          u,
          d,
          p = window.SensorsData_App_Visual_Bridge,
          ...
          m = {
            init: function (e) {
              ;(c = e),
                (u = c && c._),
                (d = (c && c.log) || (console && console.log) || function () {}),
      ...
      (br.modules.AndroidObsoleteBridge = (function () {
        ...
        function i() {
          if (
            ...
            u.registerInterceptor('sendStage', { send: { priority: 0, entry: n } }),
        ...
        function n(e, t) {
          ...
          if (l) {
            var i =
              l && l.call(s, JSON.stringify(d.extend({ server_url: u.para.server_url }, e.data)))
            return i
              ? (d.isFunction(r) && r(), t.cancellationToken.cancel(), e)
              : u.para.app_js_bridge.is_send
              ? (u.debug.apph5({ data: e.data, step: '3.1', output: 'all' }), e)
              : (d.isFunction(r) && r(), t.cancellationToken.cancel(), e)
          }
          return (
            o && o.call(s, JSON.stringify(d.extend({ server_url: u.para.server_url }, e.data))),
            d.isFunction(r) && r(),
            t.cancellationToken.cancel(),
            e
          )
        ...
        function a(e) {
          ...
          return t in m.commands
            ? m.commands[t](e, s)
            : s && d.isFunction(s.sensorsdata_js_call_app)
            ? s.sensorsdata_js_call_app(JSON.stringify(e))
            : void 0
        }
        var s,
          ...
          v = {
            init: function (e) {
              ;(u = e),
                (d = u && u._),
                (p = (u && u.log) || (console && console.log) || function () {}),
          ...
          if (
            ...
            if (
              ...
              o.para.app_js_bridge &&
                ...
                (o.bridge.is_verify_success = n && o.bridge.validateAppUrl(n)),
      ...
      (br.modules.IosObsoleteBridge = (function () {
        ...
        function e() {
          if (n && !n.bridge.activeBridge && t()) {
            ...
            n.registerInterceptor('sendStage', { send: { priority: 0, entry: i } }),
          ...
          if (/sensors-verify/.test(navigator.userAgent)) {
            ...
            if (e && e[0] && 'string' == typeof e[1] && 2 === e[1].split('?').length) {
              ...
              var t = null,
                r = null
              try {
                ;(t = a.URL(n.para.server_url).hostname),
                  (r = a.URL(n.para.server_url).searchParams.get('project') || 'default')
              } catch (i) {
                n.log(i)
              }
        ...
        function i(e, t) {
          function r(e) {
            var t = JSON.stringify(a.extend({ server_url: n.para.server_url }, e))
            return (
              (t = t.replaceAll(/\r\n/g, '')),
          ...
          return n.para.app_js_bridge.is_send
            ...
            : (a.isFunction(i) && i(), t.cancellationToken.cancel(), e)
        }
        var n,
          a,
          s,
          o = {
            init: function (t) {
              ;(n = t),
                (a = n && n._),
                (s = (n && n.log) || (console && console.log) || function () {}),
      ...
      'string' == typeof window.sensorsDataAnalytic201505
        ...
        ? (window.sensorsDataAnalytic201505 = br)
        : (qi = window.sensorsDataAnalytic201505)
  } catch (Vi) {
