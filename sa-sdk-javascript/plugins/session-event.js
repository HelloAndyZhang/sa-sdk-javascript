sensorsDataAnalytic201505.modules['SessionEvent'] = (function () {
  ...
  SessionEvent.prototype.addSessionID = function () {
    ...
    if (
      ...
      first_time > time ||
      latest_time > time ||
      time - first_time > 12 * 60 * 60 * 1000 ||
      time - latest_time > 30 * 60 * 1000
    ) {
  ...
  if (
    ...
    window.SensorsDataWebJSSDKPlugin.SessionEvent =
      window.SensorsDataWebJSSDKPlugin.SessionEvent || instance
  } else {
    window.SensorsDataWebJSSDKPlugin = {
