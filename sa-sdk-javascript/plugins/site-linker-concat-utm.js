sensorsDataAnalytic201505.modules['SiteLinkerConcatUtm'] = (function () {
    ...
    if (this._.isArray(sa_id) && sa_id[1]) {
      ...
      if (uid && (uid.substring(0, 1) === 'f' || uid.substring(0, 1) === 'd')) {
        if (
          ...
          uid =
            uid.substring(0, 1) + this._.base64Decode(this._.urlSafeBase64.decode(uid.substring(1)))
  ...
  if (
    ...
    window.SensorsDataWebJSSDKPlugin.SiteLinkerConcatUtm =
      window.SensorsDataWebJSSDKPlugin.SiteLinkerConcatUtm || siteLinkerConcatUtm
