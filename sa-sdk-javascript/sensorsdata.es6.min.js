...
;(function () {
  ...
  var r = t.JSON,
    ...
    s = (function a(r, i) {
      ...
      if ('object' == typeof p && p)
        return (i.stringify = p.stringify), (i.parse = p.parse), (i.runInContext = a), i
      var g,
        f = o.prototype,
        _ = f.toString,
        h = f.hasOwnProperty
      ...
      if (
            ...
            return (
              ...
              a
                ? (b = function (e, t) {
                    var r,
                      i,
                      n = '[object Function]' == _.call(e)
                    for (r in e)
                      (n && 'prototype' == r) || !h.call(e, r) || (i = 'constructor' === r) || t(r)
            ...
            P = function (e) {
              ...
              if (v)
                ...
                t = function (e) {
                  ...
                  ;(n = 1 + n - g(r, i)),
                    (a = l((s = ((e % 864e5) + 864e5) % 864e5) / 36e5) % 24),
                    (o = l(s / 6e4) % 60),
                    (d = l(s / 1e3) % 60),
                    (c = s % 1e3)
                }
          ...
          if (y('json-stringify') && !y('date-serialization')) {
            ...
            var D = function (e) {
              ...
              I = function (e, t, r, i, n, s, a) {
                ...
                if ('object' == typeof o) {
                  for (v = a.length; v--; ) if (a[v] === o) throw l()
                  if ((a.push(o), (p = []), (y = s), (s += n), '[object Array]' == u)) {
                    for (h = 0, v = o.length; h < v; h++)
                      (f = I(h, o, r, i, n, s, a)), p.push(f === g ? 'null' : f)
                    S = p.length
                      ? n
                        ? '[\n' + s + p.join(',\n' + s) + '\n' + y + ']'
                        : '[' + p.join(',') + ']'
              ...
              if (e[typeof r] && r)
                if ('[object Function]' == (o = _.call(r))) s = r
                  ...
                  for (var d, c = 0, l = r.length; c < l; )
                    (d = r[c++]),
                      ('[object String]' != (o = _.call(d)) && '[object Number]' != o) || (a[d] = 1)
                }
              if (i)
        ...
        if (!y('json-parse')) {
          var N,
            ...
            x = function () {
              for (var e, t, r, i, n, s = L, a = s.length; N < a; )
                switch ((n = s.charCodeAt(N))) {
                  case 9:
                  case 10:
                  case 13:
                  case 32:
                  ...
                  case 34:
                    for (e = '@', N++; N < a; )
                      if ((n = s.charCodeAt(N)) < 32) T()
                        ...
                        if (34 == n) break
                        for (n = s.charCodeAt(N), t = N; n >= 32 && 92 != n && 34 != n; )
                          n = s.charCodeAt(++N)
                        e += s.slice(t, N)
                      }
                  ...
                  default:
                    if (
                      ((t = N), 45 == n && ((i = !0), (n = s.charCodeAt(++N))), n >= 48 && n <= 57)
                    ) {
                      for (
                        48 == n && (n = s.charCodeAt(N + 1)) >= 48 && n <= 57 && T(), i = !1;
                        N < a && (n = s.charCodeAt(N)) >= 48 && n <= 57;
                        N++
                      );
                      ...
                      if (101 == (n = s.charCodeAt(N)) || 69 == n) {
                        for (
                          (43 != (n = s.charCodeAt(++N)) && 45 != n) || N++, r = N;
            ...
            J = function (e, t, r) {
              ...
              if ('object' == typeof n && n)
                if ('[object Array]' == _.call(n)) for (i = n.length; i--; ) R(_, b, n)
                else
                  b(n, function (e) {
                    R(n, e, r)
                  })
          ...
          i.parse = function (e, t) {
            ...
            return (
              ...
              '$' != x() && T(),
              (N = L = null),
              t && '[object Function]' == _.call(t) ? J((((i = {})[''] = r), i), '', t) : r
            )
          }
        }
      }
  ...
  t.JSON = { parse: s.parse, stringify: s.stringify }
}.call(window),
  (function (e) {
    if (e.atob)
      try {
      ...
      ;(e.btoa = function (e) {
        ...
        (e.atob = function (e) {
          ...
          for (var t, r, s, a = '', o = 0; o < e.length; )
            (t =
              (i.indexOf(e.charAt(o++)) << 18) |
              (i.indexOf(e.charAt(o++)) << 12) |
              ((r = i.indexOf(e.charAt(o++))) << 6) |
              (s = i.indexOf(e.charAt(o++)))),
              (a +=
                64 === r
  ...
  return (
    ...
    (t.prototype._parse = function (e) {
      ...
      for (var s in ((t = this._regex.exec(i)), this._fields))
        'undefined' != typeof t[this._fields[s]] && (this._values[s] = t[this._fields[s]])
...
;(ConcurrentStorage.prototype.get = function (e, t, r, i) {
  ...
  var n = this.lockGetPrefix + e,
    ...
    a = String(getRandom())
  if (s && (s = safeJSONParse(s) || { randomNum: 0, expireTime: 0 }).expireTime > now())
    return i(null)
  _localStorage.set(n, JSON.stringify({ randomNum: a, expireTime: now() + t })),
    setTimeout(function () {
      ;(s = safeJSONParse(_localStorage.get(n)) || { randomNum: 0, expireTime: 0 }) &&
      s.randomNum === a
        ? (i(_localStorage.get(e)), _localStorage.remove(e), _localStorage.remove(n))
        : i(null)
    }, r)
}),
  (ConcurrentStorage.prototype.set = function (e, t, r, i, n) {
    ...
    var s = this.lockSetPrefix + e,
      ...
      o = String(getRandom())
    if (a && (a = safeJSONParse(a) || { randomNum: 0, expireTime: 0 }).expireTime > now())
      return n({ status: 'fail', reason: 'This key is locked' })
    _localStorage.set(s, JSON.stringify({ randomNum: o, expireTime: now() + r })),
      setTimeout(function () {
        ;(a = safeJSONParse(_localStorage.get(s)) || { randomNum: 0, expireTime: 0 }).randomNum ===
        o
          ? _localStorage.set(e, t) && n({ status: 'success' })
          : n({ status: 'fail', reason: 'This key is locked' })
      }, i)
  }),
    ...
    var r =
      ...
      (function () {
        ...
        for (e = 0; e < r.length; e++)
          (t = r.charCodeAt(e)), i.unshift(255 & t), i.length >= 4 && ((n = s(n, i)), (i = []))
...
function addEvent(e, t, r, i) {
  ...
  ;(function (e, t, r) {
    if ((i === undefined && 'click' === t && (i = !0), e && e.addEventListener))
      e.addEventListener(
        t,
        function (e) {
      ...
      e[s] = (function (e, t, r, i) {
        return function (s) {
          ...
          return (
            ...
            (o = t.call(e, s)),
            'beforeunload' !== i ? ((!1 !== a && !1 !== o) || (d = !1), d) : void 0
          )
        }
      })(e, r, a, t)
    }
...
DomElementInfo.prototype = {
  ...
  getCssStyle: function (e) {
    ...
    var r = null
    if (
      ('function' == typeof window.getMatchedCSSRules && (r = window.getMatchedCSSRules(this.ele)),
      !r || !isArray(r))
    )
      return null
...
function each(e, t, r) {
  ...
  else if (isArray(e)) for (var i = 0, n = e.length; i < n; i++) i in e && t.call(r, e[i], i, e)
  else for (var s in e) hasOwnProperty$2.call(e, s) && t.call(r, e[s], s, e)
}
var hasOwnProperty$1 = Object.prototype.hasOwnProperty
function extend(e) {
  return (
    each(Array.prototype.slice.call(arguments, 1), function (t) {
...
function ajax(e) {
  ...
  var i,
    n = (e = extend({ success: function () {}, error: function () {} }, e)).success,
    s = e.error
  ...
  try {
    e.credentials && (r.withCredentials = !0),
      ...
      e.data &&
        (e.cors || (r.setRequestHeader && r.setRequestHeader('X-Requested-With', 'XMLHttpRequest')),
...
function bindReady(e, t) {
  ...
  var r = !1,
    ...
    l = function (i) {
      ;('readystatechange' == i.type && 'complete' != n.readyState) ||
        (('load' == i.type ? t : n)[d](c + i.type, l, !1), !r && (r = !0) && e.call(t, i.type || i))
    },
    u = function () {
      try {
        s.doScroll('left')
  ...
  if ('complete' == n.readyState) e.call(t, 'lazy')
    ...
    n[o](c + 'DOMContentLoaded', l, !1),
      n[o](c + 'readystatechange', l, !1),
      t[o](c + 'load', l, !1)
  }
}
var cookie = {
  ...
  set: function (e, t, r, i, n, s, a) {
    ...
    e && (g = p(e)),
      t && (f = p(t)),
      o && (_ = p(o)),
      g && f && (document.cookie = g + '=' + encodeURIComponent(f) + d + '; path=/' + _ + l + c)
  },
  remove: function (e, t) {
    this.set(e, '1', -1, t)
  },
...
function extend2Lev(e) {
  return (
    each(Array.prototype.slice.call(arguments, 1), function (t) {
      for (var r in t)
        void 0 !== t[r] && (isObject(t[r]) && isObject(e[r]) ? extend(e[r], t[r]) : (e[r] = t[r]))
    }),
    e
  )
}
    ...
    for (var n = '.' + i.splice(i.length - 1, 1); i.length > 0; )
      if (
        ...
        return (
          ...
          (document.cookie =
            t + '=true; expires=' + s.toGMTString() + '; path=/; SameSite=Lax; domain=' + n),
          n
        )
      }
  return ''
...
function getElementContent(e, t) {
  var r = '',
    i = ''
  return (
    e.textContent ? (r = trim(e.textContent)) : e.innerText && (r = trim(e.innerText)),
    r &&
      (r = r
        .replace(/[\r\n]/g, ' ')
        .replace(/[ ]+/g, ' ')
  ...
  if (e.length > 0)
    for (var n = e.split(''), s = 0; s < n.length; s++) {
      var a = n[s].charCodeAt(),
        o = 31 * i + a
      if (o > t) for (i = r + i; (o = 31 * i + a) < r; ) i = i / 2 + a
      if (o < r) for (i = t + i; (o = 31 * i + a) > t; ) i = i / 2 + a
      i = 31 * i + a
    }
  return i
}
...
function isSupportBeaconSend() {
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
    var i = (r.match(/os [\d._]*/gi) + '')
      .replace(/[^0-9|_.]/gi, '')
      .replace(/_/gi, '.')
      .split('.')
    'undefined' == typeof t.safari && (t.safari = i[0]),
      i[0] && (t.qqBuildinBrowser || t.qqBrowser)
        ? (e = !1)
        : i[0] && i[0] < 13
  ...
  ;({
    ...
    listen: function () {
      if (this.isSupport()) {
        ...
        addEvent(window, 'focus', this.visibleHandler), addEvent(window, 'blur', this.hiddenHandler)
    }
  }.init())
}
...
function throttle(e, t, r) {
  ...
  return function () {
    ...
    return (
      ...
      (n = arguments),
      l <= 0 || l > t
        ? (a && (clearTimeout(a), (a = null)), (o = c), (s = e.apply(i, n)), a || (i = n = null))
        : a || !1 === r.trailing || (a = setTimeout(d, l)),
      s
    )
  }
}
...
function sdLog() {
  if (
    ...
    (!isObject(arguments[0]) ||
      (!0 !== sdPara.show_log && 'string' !== sdPara.show_log && !1 !== sdPara.show_log) ||
...
function decrypt(e) {
  return (
    0 === e.indexOf(flag)
      ? (e = rot13defs((e = e.substring(flag.length))))
      : 0 === e.indexOf(flag_dfm) && (e = dfmapping((e = e.substring(flag_dfm.length)))),
    e
  )
}
...
function getEleInfo(e) {
  ...
  return (
    ...
    (i.$element_content = getElementContent$1(t, r)),
    ((i = strip_empty_properties(i)).$url = getURL()),
    (i.$url_path = getURLPath()),
...
function isReferralTraffic(e) {
  return (
    ...
    getCookieTopLevelDomain(getHostname(e), domain_test_key) !==
...
function getReferrer(e, t) {
  return 'string' != typeof (e = e || document.referrer)
    ...
    : (0 !== (e = _decodeURI((e = trim(e)))).indexOf('https://www.baidu.com/') ||
        t ||
        (e = e.split('?')[0]),
      'string' == typeof (e = e.slice(0, sdPara.max_referrer_string_length)) ? e : '')
}
function getReferSearchEngine(e) {
  ...
  for (var i in r) for (var n = r[i], s = 0, a = n.length; s < a; s++) if (n[s].test(t)) return i
  return '\u672a\u77e5\u641c\u7d22\u5f15\u64ce'
}
...
function getWxAdIdFromUrl(e) {
  ...
  return (
    isString(t) &&
      ...
      isString(r) && r.length && (n.hash_key = r),
      isString(i) && i.length && (n.callbacks = i)),
    n
  )
}
var pageInfo = {
...
function getElementContent$1(e, t) {
  return isString(t) && 'input' === t.toLowerCase()
...
function isNewUser() {
  return cookie$1.isSupport()
    ? null !== cookie$1.get('sensorsdata_is_new_user') ||
        null !== cookie$1.get(getNewUserFlagKey('new_user'))
    : null !== memory.get(memory.getNewUserFlagMemoryKey('new_user'))
}
...
var memory = {
  ...
  saNewUser = {
    checkIsAddSign: function (e) {
      'track' === e.type &&
        (isNewUser() ? (e.properties.$is_first_day = !0) : (e.properties.$is_first_day = !1))
    },
    ...
    setDeviceId: function (e) {
      ...
      null != (r = decryptIfNeeded(r)) &&
        ...
        !0 === sd.para.cross_subdomain
          ...
          : ((i.$device_id = t),
            (i = JSON.stringify(i)),
            sd.para.encrypt_cookie && (i = encrypt(i)),
            cookie$1.set('sensorsdata2015jssdkcross' + sd.para.sdk_id, i, null, !0)),
    ...
    storeInitCheck: function () {
      if (sd.is_first_visitor) {
        ...
        cookie$1.isSupport()
          ? cookie$1.set(getNewUserFlagKey('new_user'), '1', 3600 * t.h + 60 * t.m + t.s + 's')
          : memory.set(
        ...
        (sd.para.preset_properties.search_keyword_baidu
          ...
          : sd.store._state &&
            ...
            sd.store._state.props.$search_keyword_id_hash &&
              delete sd.store._state.props.$search_keyword_id_hash),
        sd.store.save(),
        each(sd.para.preset_properties, function (r, i) {
            ...
            if ('utm' !== i && 'url\u89e3\u6790\u5931\u8d25' === e)
              ...
              switch (i) {
                ...
                case 'wx_ad_click_id':
                  ...
                  ;(t._latest_wx_ad_click_id = n.click_id),
                    (t._latest_wx_ad_hash_key = n.hash_key),
                    (t._latest_wx_ad_callbacks = n.callbacks)
              }
          } else if ('utm' === i && sd.store._state && sd.store._state.props)
            for (var s in sd.store._state.props)
              (0 === s.indexOf('$latest_utm') ||
                (0 === s.indexOf('_latest_') && s.indexOf('_latest_wx_ad_') < 0)) &&
                delete sd.store._state.props[s]
          else if (
            sd.store._state &&
            sd.store._state.props &&
            '$latest_' + i in sd.store._state.props
          )
            delete sd.store._state.props['$latest_' + i]
  ...
  store = {
    ...
    initSessionState: function () {
      var e = cookie$1.get('sensorsdata2015session'),
        t = null
      null !== (e = decryptIfNeeded(e)) &&
        'object' == typeof (t = safeJSONParse(e)) &&
    ...
    setProps: function (e, t) {
      var r = {}
      for (var i in (r = t ? e : extend(this._state.props || {}, e)))
        'string' == typeof r[i] && (r[i] = r[i].slice(0, sd.para.max_referrer_string_length))
      this.set('props', r)
    },
    ...
    save: function () {
      ...
      delete e._first_id,
        ...
        e.identities && (e.identities = base64Encode(JSON.stringify(e.identities)))
      var t = JSON.stringify(e)
      sd.para.encrypt_cookie && (t = encrypt(t)),
        cookie$1.set(this.getCookieName(), t, 73e3, sd.para.cross_subdomain)
    },
    ...
    init: function () {
      ...
      var e,
        ...
        r = UUID()
      cookie$1.isSupport() &&
        (t = safeJSONParse((e = decryptIfNeeded((e = cookie$1.get(this.getCookieName())))))),
        cookie$1.isSupport() &&
        null !== e &&
        isJSONString(e) &&
        isObject(t) &&
        (!isObject(t) || t.distinct_id)
          ? ((sd.store._state = extend(
              (function (e) {
                var t
                e.identities &&
                  (0 === e.identities.indexOf('\n/')
                    ? (e.identities = safeJSONParse(rot13defs(e.identities)))
                    : (e.identities = safeJSONParse(base64Decode(e.identities))))
                var r = store.getOriginUnionId(e)
                e.identities && isObject(e.identities) && !isEmptyObject(e.identities)
                  ? e.identities.$identity_anonymous_id &&
                    e.identities.$identity_anonymous_id !== r.anonymous_id &&
                    (e.identities.$identity_anonymous_id = r.anonymous_id)
                  : ((e.identities = {}),
                    (e.identities.$identity_anonymous_id = r.anonymous_id),
                  ...
                  if (i && e.identities.hasOwnProperty(i)) {
                    ...
                    for (t in ((e.identities[n] = r.login_id), e.identities))
                      e.identities.hasOwnProperty(t) &&
                        ...
                        t !== n &&
                        delete e.identities[t]
                    e.history_login_id = { name: n, value: r.login_id }
                  }
                else {
                  if (
                    e.identities.hasOwnProperty('$identity_login_id') ||
                    e.identities.hasOwnProperty(i)
                  )
          ...
          : ((sd.is_first_visitor = !0),
            (function (e) {
              sd.store.set('distinct_id', e),
                sd.store.set('identities', { $identity_cookie_id: e }),
                sd.store.set('history_login_id', { name: '', value: '' })
            })(r)),
        saNewUser.setDeviceId(r),
        saNewUser.storeInitCheck(),
        saNewUser.checkIsFirstLatest()
    },
    saveObjectVal: function (e, t) {
      isString(t) || (t = JSON.stringify(t)),
        1 == sd.para.encrypt_cookie && (t = encrypt(t)),
  ...
  checkOption = {
    ...
    event: {
      ...
      onComplete: function (e, t, r) {
        return (
          e ||
            ('emptyString' === r && (t = 'eventName'), isFunction(checkLog[r]) && checkLog[r](t)),
          !0
        )
      }
    },
    ...
    properties: function (e) {
      return (
        isObject(e)
          ? each(e, function (e, t) {
              check({ propertyKey: t })
              check({ propertyValue: e }, function (e, r, i) {
    ...
    item_type: {
      ...
      onComplete: function (e, t, r) {
        return (
          e ||
            ('emptyString' === r && (t = 'item_type'), isFunction(checkLog[r]) && checkLog[r](t)),
          !0
        )
      }
    },
    item_id: {
      ...
      onComplete: function (e, t, r) {
        return (
          e || ('emptyString' === r && (t = 'item_id'), isFunction(checkLog[r]) && checkLog[r](t)),
          !0
        )
      }
    },
...
var UNLIMITED_TAGS_MAP = { label: !1, li: !1, a: !0, button: !0 },
  heatmap = {
    otherTags: [],
    ...
    getTargetElement: function (e, t) {
      ...
      if (
        ...
        ry(s).prev().tagName &&
        'img' === ry(s).prev().tagName.toLowerCase()
      )
        return ry(s).prev()
      if (
        'div' === n &&
      ...
      return (
        r.hasElement({ event: (t && t.originalEvent) || t, element: e }, function (e) {
    ...
    getEleDetail: function (e) {
      ...
      var i = sd.heatmap.getElementPosition(
        e,
        r.$element_path,
        sd.para.heatmap && 'not_use_id' === sd.para.heatmap.element_selector
      )
    ...
    isStyleTag: function (e, t) {
      return (
        ...
        (!t || (sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div)
          ? !!(
      ...
      var t = (function (e) {
        ...
        func: function (e, t) {
          ...
          ;((n > sd.para.heatmap.scroll_delay_time && r - e.$viewport_position != 0) || t) &&
            ...
            (e.event_duration = Math.min(sd.para.heatmap.scroll_event_duration, parseInt(n) / 1e3)),
      ...
      isFunction(sd.para.heatmap.collect_url) &&
        ...
        'all' === sd.para.heatmap.collect_elements
          ...
          : addEvent$1(document, 'click', function (r) {
              ...
              s
                ? e.start(i, s, s.tagName.toLowerCase())
                : isElement(n) &&
                  'div' === n.tagName.toLowerCase() &&
                  isObject(sd.para.heatmap) &&
                  sd.para.heatmap.get_vtrack_config &&
                  sd.unlimitedDiv.events.length > 0 &&
                  sd.unlimitedDiv.isTargetEle(n) &&
                  e.start(i, n, n.tagName.toLowerCase(), { $lib_method: 'vtrack' })
            })
    }
  },
  commonWays = {
    ...
    setInitReferrer: function () {
      var e = getReferrer()
      sd.setOnceProfile({ _init_referrer: e, _init_referrer_host: pageInfo.pageProp.referrer_host })
    },
    ...
    autoTrackSinglePage: function (e, t) {
      ...
      function s(e, t) {
        sd.track(
          '$pageview',
          extend(
            { $referrer: r, $url: getURL(), $url_path: getURLPath(), $title: document.title },
            e,
            i()
          ),
          t
      ...
      if (
        ...
        sd.is_first_visitor && n)
      ) {
        var a = {}
        sd.para.preset_properties.search_keyword_baidu &&
          isReferralTraffic(document.referrer) &&
          isBaiduTraffic() &&
          ((a.$search_keyword_id = getBaiduKeyword.id()),
          (a.$search_keyword_id_type = getBaiduKeyword.type()),
          (a.$search_keyword_id_hash = hashCode53(a.$search_keyword_id))),
          sd.setOnceProfile(
            extend(
              {
    ...
    autoTrackWithoutProfile: function (e, t) {
      ;(e = isObject(e) ? e : {}), this.autoTrack(extend(e, { not_set_profile: !0 }), t)
    },
    ...
    setPlugin: function (e) {
      ...
      each(e, function (e, t) {
        isFunction(e) &&
          (isObject(window.SensorsDataWebJSSDKPlugin) && window.SensorsDataWebJSSDKPlugin[t]
...
function addSinglePageEvent(e) {
  ...
  isFunction(window.history.pushState) &&
    ...
    (t = window.document.documentMode ? 'hashchange' : i ? 'popstate' : 'hashchange'),
      ...
      sd.para.preset_properties.latest_referrer &&
        ...
        (e.properties.$latest_referrer_host =
          '' === e.properties.$latest_referrer
            ? ''
            : getHostname(e.properties.$latest_referrer, '\u53d6\u503c\u5f02\u5e38'))))
}
...
function initPara(e) {
  ...
  'string' == typeof sd.para.server_url &&
    ...
    sd.para.server_url &&
      ('://' === sd.para.server_url.slice(0, 3)
        ...
        : 'http' !== sd.para.server_url.slice(0, 4) && (sd.para.server_url = ''))),
    ...
    sd.bridge.initPara()
  var n = { datasend_timeout: 6e3, send_interval: 6e3 }
  _localStorage.isSupport() && isSupportCors() && 'object' == typeof localStorage
    ? !0 === sd.para.batch_send
      ? (sd.para.batch_send = extend({}, n))
      : 'object' == typeof sd.para.batch_send &&
        (sd.para.batch_send = extend({}, n, sd.para.batch_send))
  ...
  'object' == typeof sd.para.source_type &&
    ((sd.para.source_type.utm = isArray(sd.para.source_type.utm)
      ? sd.para.source_type.utm.concat(s)
      : s),
  ...
  if (
    ...
    ;(sd.para.heatmap.clickmap = sd.para.heatmap.clickmap || 'default'),
      ...
      !0 !== sd.para.heatmap.get_vtrack_config && (sd.para.heatmap.get_vtrack_config = !1)
    ...
    if (
      ...
      if (!0 === sd.para.heatmap.collect_tags.div)
        ...
        if (
          ...
          ;-1 === indexOf([1, 2, 3], sd.para.heatmap.collect_tags.div.max_level) &&
...
function use(e, t) {
  return isString(e)
    ? isObject(window.SensorsDataWebJSSDKPlugin) &&
      ...
      ? (window.SensorsDataWebJSSDKPlugin[e].init(sd, t), window.SensorsDataWebJSSDKPlugin[e])
      : isObject(sd.modules) && isObject(sd.modules[e]) && isFunction(sd.modules[e].init)
...
function bind(e, t) {
  if (!saEvent.check({ bindKey: e, bindValue: t })) return !1
  ;(sd.store._state.identities[e] = t),
    sd.store.save(),
    saEvent.send({ type: 'track_id_bind', event: '$BindID', properties: {} })
}
function unbind(e, t) {
  if (!saEvent.check({ unbindKey: e, bindValue: t })) return !1
  if (
    isObject(sd.store._state.identities) &&
    sd.store._state.identities.hasOwnProperty(e) &&
    sd.store._state.identities[e] === t
  ) {
  ...
  var i = {}
  ;(i[e] = t),
    saEvent.send({ identities: i, type: 'track_id_unbind', event: '$UnbindID', properties: {} })
}
function trackLink(e, t, r) {
  function i(e, t, r) {
    ...
    e.event && n(e.event),
      e.ele &&
        addEvent$1(e.ele, 'click', function (e) {
          n(e)
        })
  }
...
function trackLinks(e, t, r) {
  return (
    ...
    !(!e || 'object' != typeof e) &&
      ...
      void addEvent$1(e, 'click', function (i) {
        i.preventDefault()
        var n = !1
        function s() {
...
function setItem(e, t, r) {
  saEvent.check({ item_type: e, item_id: t, properties: r }) &&
    saEvent.sendItem({ type: 'item_set', item_type: e, item_id: t, properties: r || {} })
}
...
function appendProfile(e, t) {
  saEvent.check({ propertiesMust: e }) &&
    ...
    isEmptyObject(e) || saEvent.send({ type: 'profile_append', properties: e }, t))
}
  ...
  isString(e) && (e = []).push(r),
    isArray(e)
      ? (each(e, function (e) {
        ...
        saEvent.send({ type: 'profile_unset', properties: i }, t))
...
function trackSignup(e, t, r, i) {
  'number' == typeof e && (e = String(e)),
    saEvent.check({ distinct_id: e, event: t, properties: r }) && sendSignup(e, t, r, i)
}
...
function clearPageRegister(e) {
  ...
  if (isArray(e) && e.length > 0)
    for (t = 0; t < e.length; t++)
      isString(e[t]) && e[t] in pageInfo.currentProps && delete pageInfo.currentProps[e[t]]
  else if (!0 === e) for (t in pageInfo.currentProps) delete pageInfo.currentProps[t]
}
function register(e) {
  saEvent.check({ properties: e })
    ? store.setProps(e)
...
function loginBody(e) {
  ...
  if (!saEvent.check({ distinct_id: t })) return sd.log('login id is invalid'), !1
  if (t === sd.store.getOriginDistinctId() && !n)
    return sd.log('login id is equal to distinct_id'), !1
  if (
    isObject(sd.store._state.identities) &&
    sd.store._state.identities.hasOwnProperty(i) &&
    t === sd.store._state.first_id
  )
    return !1
  if (sd.store._state.history_login_id.name !== i || t !== sd.store._state.history_login_id.value) {
    ;(sd.store._state.identities[i] = t),
      sd.store.set('history_login_id', { name: i, value: t }),
      n || store.set('first_id', s),
      sendSignup(t, '$SignUp', {}, r)
    var a = { $identity_cookie_id: sd.store._state.identities.$identity_cookie_id }
...
function login(e, t) {
  'number' == typeof e && (e = String(e)),
    !loginBody({ id: e, callback: t, name: IDENTITY_KEY.LOGIN }) && isFunction(t) && t()
}
function loginWithKey(e, t) {
  return (
    'number' == typeof t && (t = String(t)),
    'number' == typeof e && (e = String(e)),
    !!saEvent.check({ loginIdKey: e }) &&
      (IDENTITY_KEY.LOGIN === e
        ? (login(t), !1)
        : void loginBody({ id: t, callback: null, name: e }))
  )
}
function logout(e) {
  ...
  resetIdentities({ $identity_cookie_id: sd.store._state.identities.$identity_cookie_id }),
    sd.store.set('history_login_id', { name: '', value: '' })
}
function getPresetProperties() {
  ...
  return (
    sd.para.preset_properties.latest_referrer &&
      sd.para.preset_properties.latest_referrer_host &&
      (i.$latest_referrer_host = '' === i.$latest_referrer ? '' : getHostname(i.$latest_referrer)),
    i
  )
}
  ...
  on: function (e, t, r, i) {
    'function' == typeof t &&
      ...
      this.pendingEvents.length > 0 &&
        i &&
        each(this.pendingEvents, function (i) {
...
;(kit.buildData = function (e) {
  ...
  return (
    isObject(e) && isObject(e.identities) && !isEmptyObject(e.identities)
      ? extend(t.identities, e.identities)
      : extend(t.identities, store._state.identities),
    isObject(e) &&
      isObject(e.properties) &&
    ...
    processAddCustomProps(t),
    isObject(e.properties) && !isEmptyObject(e.properties) && extend(t.properties, e.properties),
    (e.type && 'profile' === e.type.slice(0, 7)) ||
      ...
      isString(t.properties._latest_wx_ad_click_id) && (t.properties.$url = getURL())),
...
function getSendType(e) {
  ...
  return (
    'beacon' ===
      (r =
        e.config && indexOf(t, e.config.send_type) > -1 ? e.config.send_type : sd.para.send_type) &&
...
var sendStageImpl = {
  ...
  sendState = {
    getSendCall: function (e, t, r) {
      ...
      var i = e
      e = JSON.stringify(e)
      var n = { data: i, config: t, callback: r }
      if (
        (sd.events.tempAdd('send', i),
        !sd.para.app_js_bridge &&
          sd.para.batch_send &&
          _localStorage.isSupport() &&
          localStorage.length < 100)
      )
        return sd.log(i), sd.batchSend.add(n.data), !1
      'item_set' === i.type || 'item_delete' === i.type
        ? this.prepareServerUrl(n)
        : sendStageImpl.stage.process('beforeSend', n),
        sd.log(i)
    },
    ...
    sendCall: function (e, t, r) {
      var i = { server_url: t, data: JSON.stringify(e.data), callback: r, config: e.config }
      isObject(sd.para.jsapp) &&
      !sd.para.jsapp.isOnline &&
      'function' == typeof sd.para.jsapp.setData
        ? (delete i.callback, (i = JSON.stringify(i)), sd.para.jsapp.setData(i))
        : this.realtimeSend(i)
    },
...
BatchSend.prototype = {
  ...
  send: function () {
    if (!(this.sendTimeStamp && now() - this.sendTimeStamp < sd.para.batch_send.datasend_timeout)) {
      ...
      if (
        ...
        (e = safeJSONParse(e) || this.generateTabStorageVal()).data.length)
      ) {
  ...
  updateExpireTime: function () {
    ...
    e &&
      (((e = safeJSONParse(e) || this.generateTabStorageVal()).expireTime =
        now() + 2 * sd.para.batch_send.send_interval),
  ...
  remove: function (e) {
    ...
    if (t) {
      for (
        var r = (safeJSONParse(t) || this.generateTabStorageVal()).data, i = 0;
        i < e.length;
        i++
      ) {
        var n = indexOf(r, e[i])
  ...
  add: function (e) {
    ...
    null === r
      ? ((this.tabKey = tabStoragePrefix + String(getRandom())), (r = this.generateTabStorageVal()))
      : (r = safeJSONParse(r) || this.generateTabStorageVal()),
      r.data.push(t),
      (r.expireTime = now() + 2 * sd.para.batch_send.send_interval),
  ...
  recycle: function () {
    for (var e = {}, t = 0; t < localStorage.length; t++) {
      ...
      if (0 === r.indexOf(tabStoragePrefix)) {
        for (
          var n = safeJSONParse(_localStorage.get(r)) || this.generateTabStorageVal(), s = 0;
          s < n.data.length;
          s++
        )
          e[n.data[s]] = !0
        if (now() > n.expireTime && this.serverUrl === n.serverUrl)
          new ConcurrentStorage('sajssdk-lock-get-').get(r, 1e4, 1e3, function (e) {
            if (e) {
              ...
              _localStorage.set(
                i.tabKey,
                JSON.stringify(
                  i.generateTabStorageVal(
                    (
                      safeJSONParse(_localStorage.get(i.tabKey)) || this.generateTabStorageVal()
                    ).data.concat(t.data)
                  )
                )
              )
        ...
        var a = safeJSONParse(_localStorage.get(r)) || { expireTime: 0 }
        ...
        (sd.getAppStatus = function (r) {
          if (
            ...
            'object' == typeof window.SensorsData_APP_JS_Bridge &&
              ...
              isJSONString((e = SensorsData_APP_JS_Bridge.sensorsdata_call_app())) &&
              (e = JSON.parse(e)),
            !r)
          )
            return e
        ...
        if (i && t.resultCbs[i]) {
          ...
          if (t.resultCbs[i])
            ...
            t.resultCbs[i].callbacks))
              t.resultCbs[i].callbacks[n].call(null, e), t.resultCbs[i].callbacks.splice(n, 1)
          return
        }
...
;(SDKJSBridge.prototype.call = function (e, t) {
  ...
  ;(this.resultCbs[i] = r.resultCbs[i] || { result: null, callbacks: [] }),
    ...
    ((e = e.data ? e : { data: e }).data.message_id = i)
  var n = extend({ callType: this.type }, e)
  return (
    t &&
      (this.timerId = setTimeout(function () {
        for (var e in ((r.timeoutCbs[i].isTimeout = !0), r.timeoutCbs[i].callbacks))
  ...
  (SDKJSBridge.prototype.notifyApp = function (e, t) {
    var r = extend({ callType: this.type }, e)
...
var vtrackBase = {
    initUrl: function () {
      var e,
        t,
        r = { server_url: { project: '', host: '' }, page_url: { host: '', pathname: '' } }
      if (!isString(sd.para.server_url))
        return sd.log('----vcollect---server_url\u5fc5\u987b\u4e3a\u5b57\u7b26\u4e32'), !1
      try {
    ...
    configIsMatchOldVersion: function (e, t) {
      ...
      } else if (sd.vtrackBase.isDiv({ element_path: t.element_path })) {
    ...
    getProp: function (e, t) {
      ...
      if ('content' === e.method) {
        ...
        if (isString(e.element_selector) && e.element_selector.length > 0)
          s = getDomBySelector(e.element_selector)
        else {
    ...
    init: function () {
      sd.vtrackcollect.init(),
        'success' === sd.bridge.bridge_info.verify_success && sd.vapph5collect.init()
    }
  },
  unlimitedDiv = {
    events: [],
  ...
  vtrackcollect = {
    ...
    initUrl: function () {
      ...
      if (e) {
        var t
        try {
          ;((t = new urlParse(sd.para.server_url))._values.Path = '/config/visualized/Web.conf'),
            (e.api_url = t.getUrl())
        } catch (r) {
    ...
    init: function () {
      ...
      if ((_localStorage.isSupport() || (this.storageEnable = !1), !this.initUrl()))
        return (
          sd.log(
    ...
    getConfigFromServer: function () {
      ...
      this.sendRequest(
        function (t, r) {
          ...
          var i = {}
          200 === t
            ? r && isObject(r) && 'Web' === r.os && ((i = r), e.updateConfig(i))
            : 205 === t
            ? e.updateConfig(i)
            : 304 === t
            ? (i = e.config)
            : (sd.log('----vtrackcustom----\u6570\u636e\u5f02\u5e38', t), e.updateConfig(i)),
            e.updateStorage(i),
            e.setNextFetch()
        },
        function (t) {
          ;(e.update_time = new Date().getTime()),
            sd.log('----vtrackcustom----\u914d\u7f6e\u62c9\u53d6\u5931\u8d25', t),
            e.setNextFetch()
        }
      )
    },
  ...
  vapph5CustomProp = {
    ...
    geth5Props: function (e) {
      ...
      if ('$WebClick' === e.event) {
        ...
        each(n, function (n) {
          isObject(n) &&
            (isArray(n.properties) &&
              n.properties.length > 0 &&
              each(n.properties, function (r) {
                if (isObject(r))
                  if (!1 === r.h5)
...
var heatmapMode = {
              ...
              setTimeout(function () {
                'undefined' != typeof sa_jssdk_heatmap_render &&
                  ...
                  'object' == typeof console &&
                    ...
                    ((sd.heatmap_version && sd.heatmap_version === sd.lib_version) ||
                      console.log(
    ...
    isWindowNameHasKeyword: function () {
      try {
        var e = JSON.parse(window.name),
          t = isString(e['sa-request-page-url'])
            ? _decodeURIComponent(e['sa-request-page-url'])
            : null
  ...
  vtrackMode = {
    ...
    isSearchHasKeyword: function () {
      return (
        (!0 === getFlagValue('sa-visual-mode') || 'true' === getFlagValue('sa-visual-mode')) &&
        ('string' == typeof sessionStorage.getItem('sensors_heatmap_id') &&
    ...
    messageListener: function (e) {
      ...
      if ('v-track-mode' === e.data.type) {
        if (e.data.data && e.data.data.isVtrack)
          if (
            (_sessionStorage.isSupport() && sessionStorage.setItem('sensors-visual-mode', 'true'),
            e.data.data.userURL && location.href.match(/sa-visual-mode=true/))
          ) {
            var t = isHttpUrl((r = e.data.data.userURL))
              ? removeScriptProtocol(r)
              : (sd.log('\u53ef\u89c6\u5316\u6a21\u5f0f\u68c0\u6d4b URL \u5931\u8d25'), !1)
      ...
      if (isObject(sd.para.app_js_bridge) && 'success' === t.verify_success)
        if (e) sa_jssdk_app_define_mode(sd, e)
          ...
          loadScript({
            ...
            type: 'js',
            url:
              (i = indexOf(['http:', 'https:'], i) > -1 ? i : 'https:') +
              '//static.sensorsdata.cn/sdk/' +
              sd.lib_version +
              '/vapph5define.min.js'
          })
...
function listenSinglePage() {
  sd.para.is_track_single_page &&
    spa.on('switch', function (e) {
      var t = function (t) {
        ;(t = t || {}),
          e !== location.href &&
            ((pageInfo.pageProp.referrer = getURL(e)),
            sd.quick('autoTrack', extend({ $url: getURL(), $referrer: getURL(e) }, t)))
      }
...
;(Stage.prototype.process = function (e, t) {
  if (e && e in this.processDef) {
    ...
    if (r && isArray(r) && r.length > 0)
      for (
        var i = { current: 0, total: r.length }, n = new InterceptorContext(t, i, sd), s = 0;
        s < r.length;
        s++
      )
        try {
      ...
      for (var t in e) {
        ...
        if (r && isObject(r) && isFunction(r.entry)) {
          isNumber(r.priority) || (r.priority = Number.MAX_VALUE),
            this.registeredInterceptors[t] || (this.registeredInterceptors[t] = [])
...
var processDef = { addCustomProps: null, formatData: null },
  dataStage = new Stage(processDef),
  processDef$1 = { beforeSend: 'send', send: 'afterSend', afterSend: null },
  sendStage = new Stage(processDef$1),
  processDef$2 = { getUtmData: null },
  businessStage = new Stage(processDef$2)
function registerFeature(e) {
  e && e.dataStage && dataStage.registerStageImplementation(e.dataStage),
    e && e.businessStage && businessStage.registerStageImplementation(e.businessStage),
    e && e.sendStage && sendStage.registerStageImplementation(e.sendStage)
}
...
function formatItem(e) {
  if ('item_type' in e) {
    check({ item_type: e.item_type }, function (t) {
      return t || delete e.item_type, !0
    })
  }
  if ('item_id' in e) {
    check({ item_id: e.item_id }, function (t, r, i) {
...
function formatProperties(e) {
  each(e, function (t, r) {
    check({ propertyKey: r }, function (t, i, n) {
...
;(sd.init = function (e) {
  if ((ee.sdk.emit('beforeInit'), sd.readyState && sd.readyState.state && sd.readyState.state >= 2))
    return !1
  is_compliance_enabled && implementCore(!0),
    ee.initSystemEvent(),
    sd.setInitVar(),
...
try {
  ;(sd.modules = {}),
    ...
    (sd.modules.Deeplink = (function () {
      ...
      var i = { android: /Android/i, iOS: /iPhone|iPad|iPod/i },
        ...
        a = {
          ...
          init: function () {
            ...
            if (
              (s(sensorsDataAnalytic201505) && (this.sd = sensorsDataAnalytic201505),
              this.log('init()'),
              null === this.sd)
            )
            ...
            if (
              (arguments.length > 0 &&
                (1 === arguments.length && s(arguments[0])
                  ? (e = arguments[0])
                  : arguments.length >= 2 && s(arguments[1]) && (e = arguments[1])),
              !i.hasOwnProperty(n))
            )
              return (
                this.log(
                  ...
                  t.log('\u5524\u8d77APP\u7684\u5730\u5740\uff1a' + s),
                    ...
                    (t.timer = setTimeout(function () {
                      ...
                      if ((t.log('hide:' + e + ':' + document[e]), i))
                        return t.log('The page is hidden, stop navigating to download page'), !1
                      t.log(
                        'App\u53ef\u80fd\u672a\u5b89\u88c5\uff0c\u8df3\u8f6c\u5230\u4e0b\u8f7d\u5730\u5740'
                      ),
                        (window.location = n)
      ...
      return (
        s(window.SensorsDataWebJSSDKPlugin)
          ? ((window.SensorsDataWebJSSDKPlugin.Deeplink =
              window.SensorsDataWebJSSDKPlugin.Deeplink || a),
            (window.SensorsDataWebJSSDKPlugin.deeplink =
              window.SensorsDataWebJSSDKPlugin.deeplink || a))
          : (window.SensorsDataWebJSSDKPlugin = { Deeplink: a, deeplink: a }),
        a
      )
    })()),
      ...
      ;(e.prototype.init = function (e, t) {
        if (e) {
          ...
          ;(this.page_id = Number(
            ...
            !0 === document.hidden ? (this.page_show_status = !1) : this.addHeartBeatInterval(),
          ...
          function t() {
            ...
            if (r && r.timing) {
              ...
              0 === s.fetchStart || 0 === s.domContentLoadedEventEnd
                ...
                : (i = s.domContentLoadedEventEnd - s.fetchStart),
                (function (t, r) {
                  if (t.getEntries && 'function' == typeof t.getEntries) {
                    for (var i = t.getEntries(), n = null, s = 0; s < i.length; s++)
            ...
            i > 0 && (n.event_duration = Number((i / 1e3).toFixed(3))),
              e.track('$WebPageLoad', n),
              window.removeEventListener
    ...
    (sd.modules.RegisterProperties = (function () {
      ...
      function e(e) {
        var t = this
        ;(this.sd = e.sd),
          (this.currentProps = e.customRegister),
          (this.interceptor = {
            addCustomProps: {
              priority: 0,
              entry: function (e) {
      ...
      ;(e.prototype.init = function () {}),
        (r.prototype.init = function (e) {
          e
            ? ((this.sd = e), (this._ = e._), (this.log = e.log), e.registerFeature(new t(this)))
      ...
      return (
        ...
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
          ? (window.SensorsDataWebJSSDKPlugin.RegisterProperties =
              window.SensorsDataWebJSSDKPlugin.RegisterProperties || i)
          : (window.SensorsDataWebJSSDKPlugin = { RegisterProperties: i }),
        i
      )
    })()),
    (sd.modules.RegisterPropertyPageHeight = (function () {
      ...
      var e,
        t,
        r = (window.console && window.console.log) || function () {}
      function i(i) {
        try {
        ...
        init: function (n) {
          ;(r = ((e = n) && e.log) || r),
            n && n.kit && n.kit.buildData
              ? ((t = e.kit.buildData),
                (e.kit.buildData = i),
                r('RegisterPropertyPageHeight \u63d2\u4ef6\u521d\u59cb\u5316\u5b8c\u6210'))
              : r(
            ...
            if (this.getPartHash(e))
              (n = o.indexOf('_sasdk')),
                (i =
                  o.indexOf('?') > -1
                    ? n > -1
                      ? s + a + '#' + o.substring(1, n) + '_sasdk=' + this.getCurrenId()
                      : s + a + '#' + o.substring(1) + '&_sasdk=' + this.getCurrenId()
                    : s + a + '#' + o.substring(1) + '?_sasdk=' + this.getCurrenId())
            else
              (n = a.indexOf('_sasdk')),
                (i = /^\?(\w)+/.test(a)
                  ? n > -1
                    ? s + '?' + a.substring(1, n) + '_sasdk=' + this.getCurrenId() + o
                    : s + '?' + a.substring(1) + '&_sasdk=' + this.getCurrenId() + o
                  : s + '?' + a.substring(1) + '_sasdk=' + this.getCurrenId() + o)
            return t && (t.href = i), i
          }
        },
    ...
    (sd.modules.AndroidBridge = (function () {
      ...
      var s,
        ...
        p = {
          init: function (e) {
            ;(c = (d = e) && d._),
              (l = (d && d.log) || (console && console.log) || function () {}),
              d.on && d.on('sdkAfterInitPara', g)
          },
          handleCommand: function (e) {
            var t = e.callType
            if (t in u.commands) return u.commands[t](e, s)
            s &&
              c.isFunction(s.sensorsdata_js_call_app) &&
              s.sensorsdata_js_call_app(JSON.stringify(e))
          }
        }
      function g() {
        ;(s = window.SensorsData_APP_New_H5_Bridge),
          (a = s && s.sensorsdata_track),
          (o = a && s.sensorsdata_get_server_url && s.sensorsdata_get_server_url()),
          d &&
            !d.bridge.activeBridge &&
            o &&
            ((d.bridge.activeBridge = p),
            d.para.app_js_bridge &&
              !d.para.app_js_bridge.is_mui &&
              (d.bridge.is_verify_success = o && d.bridge.validateAppUrl(o)),
            (d.bridge.bridge_info = {
              touch_app_bridge: !0,
              platform: 'android',
            ...
            d.para.app_js_bridge
              ? (d.registerInterceptor('sendStage', { send: { priority: 0, entry: f } }),
                l('Android bridge inits succeed.'))
              : l('app_js_bridge is not configured, data will not be sent by android bridge.'))
      }
      function f(e, t) {
        if (d.para.app_js_bridge.is_mui) return e
        var r = e.callback
        return d.bridge.is_verify_success
          ? (a && a.call(s, JSON.stringify(c.extend({ server_url: d.para.server_url }, e.data))),
            c.isFunction(r) && r(),
            t.cancellationToken.cancel(),
            e)
          : d.para.app_js_bridge.is_send
          ? (d.debug.apph5({ data: e.data, step: '4.2', output: 'all' }), e)
          : (c.isFunction(r) && r(), t.cancellationToken.cancel(), e)
      }
      return (
        window.SensorsDataWebJSSDKPlugin &&
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
          ? (window.SensorsDataWebJSSDKPlugin.AndroidBridge =
              window.SensorsDataWebJSSDKPlugin.AndroidBridge || p)
          : (window.SensorsDataWebJSSDKPlugin = { AndroidBridge: p }),
        p
      )
    })()),
    (sd.modules.AndroidObsoleteBridge = (function () {
      ...
      var s,
        ...
        g = {
          init: function (e) {
            ;(l = (c = e) && c._),
              (u = (c && c.log) || (console && console.log) || function () {}),
              c.on && c.on('sdkAfterInitPara', f)
          },
          handleCommand: function (e) {
            var t = e.callType
            if (t in p.commands) return p.commands[t](e, s)
            if (s && l.isFunction(s.sensorsdata_js_call_app))
              return s.sensorsdata_js_call_app(JSON.stringify(e))
          }
        }
      function f() {
        if (
          ...
          (a = s && s.sensorsdata_track),
          (o = s && s.sensorsdata_verify),
          (d = s && s.sensorsdata_visual_verify),
          c && !c.bridge.activeBridge && (o || a || d))
        ) {
          c.bridge.activeBridge = g
          var e = o || a
          d && (e = !!d.call(s, JSON.stringify({ server_url: c.para.server_url }))),
            ...
            c.para.app_js_bridge
              ? (c.registerInterceptor('sendStage', { send: { priority: 0, entry: _ } }),
                u('Android obsolete bridge inits succeed.'))
              : u(
      ...
      function _(e, t) {
        ...
        var r = e.callback
        return o
          ? o && o.call(s, JSON.stringify(l.extend({ server_url: c.para.server_url }, e.data)))
            ? (l.isFunction(r) && r(), t.cancellationToken.cancel(), e)
            : c.para.app_js_bridge.is_send
            ? (c.debug.apph5({ data: e.data, step: '3.1', output: 'all' }), e)
            : (l.isFunction(r) && r(), t.cancellationToken.cancel(), e)
          : (a && a.call(s, JSON.stringify(l.extend({ server_url: c.para.server_url }, e.data))),
            l.isFunction(r) && r(),
            t.cancellationToken.cancel(),
            e)
      }
      return (
        ...
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
          ? (window.SensorsDataWebJSSDKPlugin.AndroidObsoleteBridge =
              window.SensorsDataWebJSSDKPlugin.AndroidObsoleteBridge || g)
          : (window.SensorsDataWebJSSDKPlugin = { AndroidObsoleteBridge: g }),
        g
      )
    })()),
    (sd.modules.IosBridge = (function () {
      ...
      var e,
        ...
        o = {
          init: function (e) {
            ;(s = (n = e) && n._),
              (a = (n && n.log) || (console && console.log) || function () {}),
              n.on && n.on('sdkAfterInitPara', d)
          },
          handleCommand: function (e) {
            var t = e.callType
            if (('page_info' === t || 'visualized_track' === t) && !n.bridge.hasVisualModeBridge())
              return null
            if ('sensorsdata_get_app_visual_config' === t)
              return (
                s.isObject(window.SensorsData_APP_New_H5_Bridge) &&
                window.SensorsData_APP_New_H5_Bridge[t]
              )
            return i.call(r, JSON.stringify(e))
          }
        }
      function d() {
        ;(e = window.SensorsData_iOS_JS_Bridge),
          (t = e && e.sensorsdata_app_server_url),
          (r =
            window.webkit &&
          ...
          (i = r && r.postMessage),
          n &&
            !n.bridge.activeBridge &&
            i &&
            ((n.bridge.activeBridge = o),
            n.para.app_js_bridge &&
              !n.para.app_js_bridge.is_mui &&
              (n.bridge.is_verify_success = t && n.bridge.validateAppUrl(t)),
            (n.bridge.bridge_info = {
              touch_app_bridge: !0,
              platform: 'ios',
              verify_success: n.bridge.is_verify_success ? 'success' : 'fail',
              support_two_way_call: !0
            }),
            n.para.app_js_bridge
              ? (n.registerInterceptor('sendStage', { send: { priority: 0, entry: c } }),
                a('IOS bridge inits succeed.'))
              : a('app_js_bridge is not configured, data will not be sent by iOS bridge.'))
      }
      function c(e, t) {
        if (n.para.app_js_bridge.is_mui) return e
        var a = e.callback
        return n.bridge.is_verify_success
          ? (i.call(
              r,
              JSON.stringify({
                callType: 'app_h5_track',
                data: s.extend({ server_url: n.para.server_url }, e.data)
              })
            ),
            s.isFunction(a) && a(),
            t.cancellationToken.cancel(),
            e)
          : n.para.app_js_bridge.is_send
          ? (n.debug.apph5({ data: e.data, step: '4.1', output: 'all' }), e)
          : (s.isFunction(a) && a(), t.cancellationToken.cancel(), e)
      }
      return (
        window.SensorsDataWebJSSDKPlugin &&
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
          ? (window.SensorsDataWebJSSDKPlugin.IOSBridge =
              window.SensorsDataWebJSSDKPlugin.IOSBridge || o)
          : (window.SensorsDataWebJSSDKPlugin = { IOSBridge: o }),
        o
      )
    })()),
    (sd.modules.IosObsoleteBridge = (function () {
      ...
      var e,
        ...
        i = {
          init: function (i) {
            ;(t = (e = i) && e._),
              (r = (e && e.log) || (console && console.log) || function () {}),
              e.on && e.on('sdkAfterInitPara', n)
          }
        }
      function n() {
        !e ||
          e.bridge.activeBridge ||
          (!/sensors-verify/.test(navigator.userAgent) &&
            !/sa-sdk-ios/.test(navigator.userAgent)) ||
          window.MSStream ||
          ((e.bridge.activeBridge = i),
          (e.bridge.bridge_info = {
            touch_app_bridge: !0,
            platform: 'ios',
            verify_success: s() ? 'success' : 'fail'
          }),
          e.para.app_js_bridge
            ? (e.registerInterceptor('sendStage', { send: { priority: 0, entry: a } }),
              r('IOS obsolete bridge inits succeed.'))
            : r('app_js_bridge is not configured, data will not be sent by iOS obsolete bridge.'))
      }
      function s() {
          ...
          if (r && r[0] && 'string' == typeof r[1] && 2 === r[1].split('?').length) {
            ...
            try {
              ;(i = t.URL(e.para.server_url).hostname),
                (n = t.URL(e.para.server_url).searchParams.get('project') || 'default')
            } catch (s) {
              e.log(s)
            }
      ...
      function a(r, i) {
        ...
        if (e.bridge.bridge_info.verify_success) {
          var o = document.createElement('iframe'),
            d =
              ((n = r.data),
              (s = (s = JSON.stringify(t.extend({ server_url: e.para.server_url }, n))).replaceAll(
                /\r\n/g,
                ''
              )),
              'sensorsanalytics://trackEvent?event=' + (s = encodeURIComponent(s)))
          return (
            ...
            (o = null),
            t.isFunction(a) && a(),
            i.cancellationToken.cancel(),
            !0
          )
        }
        return e.para.app_js_bridge.is_send
          ? (e.debug.apph5({ data: r.data, step: '3.2', output: 'all' }), r)
          : (t.isFunction(a) && a(), i.cancellationToken.cancel(), r)
      }
      return (
        window.SensorsDataWebJSSDKPlugin &&
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
          ? (window.SensorsDataWebJSSDKPlugin.IOSObsoleteBridge =
              window.SensorsDataWebJSSDKPlugin.IOSObsoleteBridge || i)
          : (window.SensorsDataWebJSSDKPlugin = { IOSObsoleteBridge: i }),
        i
      )
    })()),
