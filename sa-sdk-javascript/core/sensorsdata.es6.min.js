...
;(function () {
  ...
  var r = t.JSON,
    ...
    a = (function s(r, i) {
      ...
      var n = r.Number || t.Number,
        ...
        o = r.Object || t.Object,
        c = r.Date || t.Date,
        d = r.SyntaxError || t.SyntaxError,
        l = r.TypeError || t.TypeError,
        u = r.Math || t.Math,
        p = r.JSON || t.JSON
      if ('object' == typeof p && p)
        return (i.stringify = p.stringify), (i.parse = p.parse), (i.runInContext = s), i
      var g,
        f = o.prototype,
        _ = f.toString,
        h = f.hasOwnProperty
      ...
      function y(e) {
        ...
        if ('bug-string-char-index' == e) t = 'a' != 'a'[0]
          ...
          if ('json-stringify' == e) {
            var d = 'function' == typeof (r = i.stringify)
            d &&
              (((s = function () {
                return 1
              }).toJSON = s),
      ...
      if (
        ...
        if (!y('json-stringify') && !y('date-serialization')) {
            ...
            O = function (e) {
              ...
              if (v)
                ...
                t = function (e) {
                  ...
                  ;(n = 1 + n - g(r, i)),
                    (s = l((a = ((e % 864e5) + 864e5) % 864e5) / 36e5) % 24),
                    (o = l(a / 6e4) % 60),
                    (c = l(a / 1e3) % 60),
                    (d = a % 1e3)
                }
          ...
          if (y('json-stringify') && !y('date-serialization')) {
            ...
            var C = function (e) {
              ...
              E = /[\x00-\x1f\x22\x5c]/g,
              I = function (e) {
                return (E.lastIndex = 0), '"' + (E.test(e) ? e.replace(E, C) : e) + '"'
              },
              N = function (e, t, r, i, n, a, s) {
                var o, d, u, p, f, h, v, y, S
                if (
                  (m(function () {
                    o = t[e]
                  }),
                  ...
                  return o === g ? o : 'null'
                switch (('object' == (d = typeof o) && (u = _.call(o)), u || d)) {
                  case 'boolean':
                  case '[object Boolean]':
                    return '' + o
                  case 'number':
                ...
                if ('object' == typeof o) {
                  for (v = s.length; v--; ) if (s[v] === o) throw l()
                  if ((s.push(o), (p = []), (y = a), (a += n), '[object Array]' == u)) {
                    for (h = 0, v = o.length; h < v; h++)
                      (f = N(h, o, r, i, n, a, s)), p.push(f === g ? 'null' : f)
                    S = p.length
                      ? n
                        ? '[\n' + a + p.join(',\n' + a) + '\n' + y + ']'
                        : '[' + p.join(',') + ']'
        ...
        if (!y('json-parse')) {
          var D,
            ...
            L = function () {
              for (var e, t, r, i, n, a = T, s = a.length; D < s; )
                switch ((n = a.charCodeAt(D))) {
                  case 9:
                  case 10:
                  case 13:
                  case 32:
                  ...
                  case 58:
                  case 44:
                    return (e = S ? a.charAt(D) : a[D]), D++, e
                  case 34:
                    for (e = '@', D++; D < s; )
                      if ((n = a.charCodeAt(D)) < 32) x()
                      else if (92 == n)
                        switch ((n = a.charCodeAt(++D))) {
                          case 92:
                          case 34:
                        ...
                        if (34 == n) break
                        for (n = a.charCodeAt(D), t = D; n >= 32 && 92 != n && 34 != n; )
                          n = a.charCodeAt(++D)
                        e += a.slice(t, D)
                      }
                  ...
                  default:
                    if (
                      ((t = D), 45 == n && ((i = !0), (n = a.charCodeAt(++D))), n >= 48 && n <= 57)
                    ) {
                      for (
                        48 == n && (n = a.charCodeAt(D + 1)) >= 48 && n <= 57 && x(), i = !1;
                        D < s && (n = a.charCodeAt(D)) >= 48 && n <= 57;
                        D++
                      );
                      if (46 == a.charCodeAt(D)) {
                        for (r = ++D; r < s && !((n = a.charCodeAt(r)) < 48 || n > 57); r++);
                        r == D && x(), (D = r)
                      }
                      if (101 == (n = a.charCodeAt(D)) || 69 == n) {
                        for (
                          (43 != (n = a.charCodeAt(++D)) && 45 != n) || D++, r = D;
                          r < s && !((n = a.charCodeAt(r)) < 48 || n > 57);
                          r++
                        );
                        r == D && x(), (D = r)
                      }
                    ...
                    i && x()
                    var o = a.slice(D, D + 4)
                    if ('true' == o) return (D += 4), !0
                    if ('fals' == o && 101 == a.charCodeAt(D + 4)) return (D += 5), !1
                    if ('null' == o) return (D += 4), null
                    x()
                }
              return '$'
            },
          ...
          i.parse = function (e, t) {
            ...
            return (
              ...
              '$' != L() && x(),
              (D = T = null),
              t && '[object Function]' == _.call(t) ? B((((i = {})[''] = r), i), '', t) : r
            )
          }
        }
      }
  ...
  (function (e) {
    if (e.atob)
      ...
      ;(e.btoa = function (e) {
        e = String(e)
        for (var t, r, n, a, s = '', o = 0, c = e.length % 3; o < e.length; ) {
          if (
  ...
  return (
    ...
    (t.prototype._parse = function (e) {
      ...
      var r = e.split('#'),
        i = r[0],
        n = r.slice(1).join('#')
      for (var a in ((t = this._regex.exec(i)), this._fields))
...
;(ConcurrentStorage.prototype.get = function (e, t, r, i) {
  ...
  if (a && (a = safeJSONParse(a) || { randomNum: 0, expireTime: 0 }).expireTime > now())
    return i(null)
  _localStorage.set(n, JSON.stringify({ randomNum: s, expireTime: now() + t })),
    setTimeout(function () {
      ;(a = safeJSONParse(_localStorage.get(n)) || { randomNum: 0, expireTime: 0 }) &&
      a.randomNum === s
  ...
  (ConcurrentStorage.prototype.set = function (e, t, r, i, n) {
    ...
    _localStorage.set(a, JSON.stringify({ randomNum: o, expireTime: now() + r })),
      setTimeout(function () {
        ;(s = safeJSONParse(_localStorage.get(a)) || { randomNum: 0, expireTime: 0 }).randomNum ===
        o
    ...
    var r =
      ...
      (function () {
        ...
        for (e = 0; e < r.length; e++)
          (t = r.charCodeAt(e)), i.unshift(255 & t), i.length >= 4 && ((n = a(n, i)), (i = []))
      ...
      e[a] = (function (e, t, r, i) {
        return function (a) {
          ...
          return (
            ...
            (o = t.call(e, a)),
            'beforeunload' !== i ? ((!1 !== s && !1 !== o) || (c = !1), c) : void 0
          )
        }
      })(e, r, s, t)
    }
...
function each(e, t, r) {
  ...
  else for (var a in e) hasOwnProperty$2.call(e, a) && t.call(r, e[a], a, e)
}
...
function bindReady(e, t) {
  ...
  var r = !1,
    ...
    l = function (i) {
      ;('readystatechange' == i.type && 'complete' != n.readyState) ||
        (('load' == i.type ? t : n)[c](d + i.type, l, !1), !r && (r = !0) && e.call(t, i.type || i))
    },
    u = function () {
      try {
        a.doScroll('left')
  ...
  if ('complete' == n.readyState) e.call(t, 'lazy')
    ...
    n[o](d + 'DOMContentLoaded', l, !1),
      n[o](d + 'readystatechange', l, !1),
      t[o](d + 'load', l, !1)
  }
}
var cookie = {
  ...
  set: function (e, t, r, i, n, a, s) {
    ...
    if (0 !== (r = null == r ? 73e3 : r)) {
      ...
      's' === String(r).slice(-1)
        ...
        (c = '; expires=' + u.toGMTString())
    }
    function p(e) {
      return !!e && e.replaceAll(/\r\n/g, '')
    }
    isString(n) && '' !== n && (l = '; SameSite=' + n), a && (d = '; secure')
    var g = '',
      f = '',
      _ = ''
    e && (g = p(e)),
      t && (f = p(t)),
      o && (_ = p(o)),
      g && f && (document.cookie = g + '=' + encodeURIComponent(f) + c + '; path=/' + _ + l + d)
  },
  remove: function (e, t) {
    this.set(e, '1', -1, t)
  },
      ...
      t = (function (e, t) {
        ...
        if (0 === e.indexOf('#')) (e = e.slice(1)), (r = document.getElementById(e))
          ...
          for (var o = t.children, c = 0; c < o.length; c++)
            if (isElement(o[c]) && o[c].tagName.toLowerCase() === n && 0 == --s) {
              r = o[c]
              break
            }
          if (s > 0) return null
  ...
  if (e.length > 0)
    for (var n = e.split(''), a = 0; a < n.length; a++) {
      var s = n[a].charCodeAt(),
        o = 31 * i + s
      if (o > t) for (i = r + i; (o = 31 * i + s) < r; ) i = i / 2 + s
      if (o < r) for (i = t + i; (o = 31 * i + s) > t; ) i = i / 2 + s
      i = 31 * i + s
    }
  return i
}
...
function throttle(e, t, r) {
  ...
  return function () {
    ...
    return (
      ...
      (n = arguments),
      l <= 0 || l > t
        ? (s && (clearTimeout(s), (s = null)), (o = d), (a = e.apply(i, n)), s || (i = n = null))
        : s || !1 === r.trailing || (s = setTimeout(c, l)),
      a
    )
  }
}
      ...
      ;('all' !== i && 'console' !== i) || sdLog(r[n]),
        ('all' === i || 'code' === i) &&
          ...
          ((a.type && 'profile' === a.type.slice(0, 7)) ||
            (a.properties._jssdk_debug_info = 'apph5-' + String(n)))
    },
...
var pageInfo = {
  ...
  campaignParamsStandard: function (e, t) {
    ...
    var r = pageInfo.campaignParams(),
      ...
      n = {}
    return (
      each(r, function (r, a, s) {
        ;-1 !== (' ' + source_channel_standard + ' ').indexOf(' ' + a + ' ')
          ? (i[e + a] = s[a])
          : (n[t + a] = s[a])
      }),
      { $utms: i, otherUtms: n }
      ...
      if (
        ...
        each(sd.para.preset_properties, function (r, i) {
          ...
          if (((i = i.slice(7)), r)) {
            ...
            for (var a in sd.store._state.props)
              (0 === a.indexOf('$latest_utm') ||
                (0 === a.indexOf('_latest_') && a.indexOf('_latest_wx_ad_') < 0)) &&
                delete sd.store._state.props[a]
          else if (
            sd.store._state &&
            sd.store._state.props &&
        ...
        var i = pageInfo.campaignParamsStandard('$latest_', '_latest_'),
          n = i.$utms,
          a = i.otherUtms
        isEmptyObject(n) || sd.register(n), isEmptyObject(a) || sd.register(a)
      }
    }
  },
  store = {
...
var UNLIMITED_TAGS_MAP = { label: !1, li: !1, a: !0, button: !0 },
  heatmap = {
    ...
    getElementPosition: function (e, t, r) {
      ...
      if (s > 1) {
        for (var c = 0; c < s; c++) {
          sd.heatmap.getElementPath(a[c], r) === t && o.push(a[c])
        }
    ...
    autoTrackSinglePage: function (e, t) {
      ...
      if (
        ...
        sd.para.preset_properties.search_keyword_baidu &&
          isReferralTraffic(document.referrer) &&
          isBaiduTraffic() &&
          ((s.$search_keyword_id = getBaiduKeyword.id()),
          (s.$search_keyword_id_type = getBaiduKeyword.type()),
          (s.$search_keyword_id_hash = hashCode53(s.$search_keyword_id))),
          sd.setOnceProfile(
            extend(
              {
...
function initPara(e) {
  ...
  'object' == typeof sd.para.source_type &&
    ((sd.para.source_type.utm = isArray(sd.para.source_type.utm)
      ? sd.para.source_type.utm.concat(a)
      : a),
    (sd.para.source_type.search = isArray(sd.para.source_type.search)
      ? sd.para.source_type.search.concat(s)
      : s),
    ...
    (sd.para.source_type.keyword = isObject(sd.para.source_type.keyword)
      ? extend(c, sd.para.source_type.keyword)
      : c))
  ...
  if (
    ...
    if (
      ...
      if (!0 === sd.para.heatmap.collect_tags.div)
        sd.para.heatmap.collect_tags.div = { ignore_tags: d, max_level: 1 }
        ...
        if (
          (sd.para.heatmap.collect_tags.div.ignore_tags
            ? isArray(sd.para.heatmap.collect_tags.div.ignore_tags) ||
              ...
              (sd.para.heatmap.collect_tags.div.ignore_tags = d))
            : (sd.para.heatmap.collect_tags.div.ignore_tags = d),
          sd.para.heatmap.collect_tags.div.max_level)
        ) {
...
function loginBody(e) {
  ...
  if (sd.store._state.history_login_id.name !== i || t !== sd.store._state.history_login_id.value) {
    ;(sd.store._state.identities[i] = t),
      ...
      n || store.set('first_id', a),
      sendSignup(t, '$SignUp', {}, r)
    var s = { $identity_cookie_id: sd.store._state.identities.$identity_cookie_id }
    return (s[i] = t), resetIdentities(s), !0
  }
  return !1
}
function login(e, t) {
  ...
  recycle: function () {
    for (var e = {}, t = 0; t < localStorage.length; t++) {
      ...
      if (0 === r.indexOf(tabStoragePrefix)) {
        for (
          var n = safeJSONParse(_localStorage.get(r)) || this.generateTabStorageVal(), a = 0;
          a < n.data.length;
          a++
        )
          e[n.data[a]] = !0
        ...
        var s = safeJSONParse(_localStorage.get(r)) || { expireTime: 0 }
        now() - s.expireTime > 1e4 && _localStorage.remove(r)
      }
    }
    for (var o = 0; o < localStorage.length; o++) {
      var c = localStorage.key(o)
      0 !== c.indexOf(dataStoragePrefix) || e[c] || _localStorage.remove(c)
    }
  }
}
    ...
    getProp: function (e, t) {
      ...
      if ('content' === e.method) {
        ...
        if ('input' === a.tagName.toLowerCase()) r = a.value || ''
          ...
          isNumber(c) && isElement(a[c]) && (r = getElementContent$1(a[c], 'select'))
          ...
          if (isObject(r)) {
            ...
            a &&
              ...
              isArray(n) &&
                n.length > 0 &&
                each(n, function (t) {
                  if (isObject(t) && t.url_host === a.host && t.url_path === a.pathname && t.h5) {
                    var r = e.getProp(t)
...
;(Stage.prototype.process = function (e, t) {
  if (e && e in this.processDef) {
    ...
    if (r && isArray(r) && r.length > 0)
      for (
        var i = { current: 0, total: r.length }, n = new InterceptorContext(t, i, sd), a = 0;
        a < r.length;
        a++
      )
        try {
    ...
    (sd.modules.AndroidBridge = (function () {
      ...
      var a,
        ...
        p = {
          init: function (e) {
            ;(d = (c = e) && c._),
              (l = (c && c.log) || (console && console.log) || function () {}),
              c.on && c.on('sdkAfterInitPara', g)
          },
          handleCommand: function (e) {
            var t = e.callType
            if (t in u.commands) return u.commands[t](e, a)
            a &&
              d.isFunction(a.sensorsdata_js_call_app) &&
              a.sensorsdata_js_call_app(JSON.stringify(e))
          }
        }
      function g() {
        ;(a = window.SensorsData_APP_New_H5_Bridge),
          (s = a && a.sensorsdata_track),
          (o = s && a.sensorsdata_get_server_url && a.sensorsdata_get_server_url()),
          c &&
            !c.bridge.activeBridge &&
            o &&
            ((c.bridge.activeBridge = p),
            c.para.app_js_bridge &&
              !c.para.app_js_bridge.is_mui &&
              (c.bridge.is_verify_success = o && c.bridge.validateAppUrl(o)),
            ...
            c.para.app_js_bridge
              ? (c.registerInterceptor('sendStage', { send: { priority: 0, entry: f } }),
      ...
      function f(e, t) {
        ...
        return c.bridge.is_verify_success
          ? (s && s.call(a, JSON.stringify(d.extend({ server_url: c.para.server_url }, e.data))),
            d.isFunction(r) && r(),
    ...
    (sd.modules.AndroidObsoleteBridge = (function () {
      ...
      var a,
        ...
        g = {
          init: function (e) {
            ;(l = (d = e) && d._),
              (u = (d && d.log) || (console && console.log) || function () {}),
              d.on && d.on('sdkAfterInitPara', f)
          },
          handleCommand: function (e) {
            var t = e.callType
            if (t in p.commands) return p.commands[t](e, a)
            if (a && l.isFunction(a.sensorsdata_js_call_app))
              return a.sensorsdata_js_call_app(JSON.stringify(e))
          }
        }
      function f() {
        if (
          ...
          (s = a && a.sensorsdata_track),
          (o = a && a.sensorsdata_verify),
          (c = a && a.sensorsdata_visual_verify),
          d && !d.bridge.activeBridge && (o || s || c))
        ) {
          d.bridge.activeBridge = g
          var e = o || s
          c && (e = !!c.call(a, JSON.stringify({ server_url: d.para.server_url }))),
            ...
            d.para.app_js_bridge
              ? (d.registerInterceptor('sendStage', { send: { priority: 0, entry: _ } }),
      ...
      function _(e, t) {
        ...
        var r = e.callback
        return o
          ? o && o.call(a, JSON.stringify(l.extend({ server_url: d.para.server_url }, e.data)))
            ? (l.isFunction(r) && r(), t.cancellationToken.cancel(), e)
            : d.para.app_js_bridge.is_send
            ? (d.debug.apph5({ data: e.data, step: '3.1', output: 'all' }), e)
            : (l.isFunction(r) && r(), t.cancellationToken.cancel(), e)
          : (s && s.call(a, JSON.stringify(l.extend({ server_url: d.para.server_url }, e.data))),
            l.isFunction(r) && r(),
            t.cancellationToken.cancel(),
            e)
      }
        ...
        o = {
          ...
          handleCommand: function (e) {
            ...
            if ('sensorsdata_get_app_visual_config' === t)
              return (
                a.isObject(window.SensorsData_APP_New_H5_Bridge) &&
      ...
      function c() {
        ;(e = window.SensorsData_iOS_JS_Bridge),
          ...
          n &&
            ...
            n.para.app_js_bridge
              ? (n.registerInterceptor('sendStage', { send: { priority: 0, entry: d } }),
                s('IOS bridge inits succeed.'))
              : s('app_js_bridge is not configured, data will not be sent by iOS bridge.'))
      }
      function d(e, t) {
        ...
        return n.bridge.is_verify_success
          ? (i.call(
              ...
              JSON.stringify({
                ...
                data: a.extend({ server_url: n.para.server_url }, e.data)
              })
            ),
            a.isFunction(s) && s(),
            t.cancellationToken.cancel(),
          ...
          : (a.isFunction(s) && s(), t.cancellationToken.cancel(), e)
      }
      return (
        window.SensorsDataWebJSSDKPlugin &&
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
      ...
      function n() {
        !e ||
          ...
          (e.bridge.bridge_info = {
            touch_app_bridge: !0,
            platform: 'ios',
            verify_success: a() ? 'success' : 'fail'
          }),
          e.para.app_js_bridge
            ? (e.registerInterceptor('sendStage', { send: { priority: 0, entry: s } }),
      ...
      function s(r, i) {
        ...
        if (e.bridge.bridge_info.verify_success) {
          var o = document.createElement('iframe'),
            c =
              ((n = r.data),
              (a = (a = JSON.stringify(t.extend({ server_url: e.para.server_url }, n))).replaceAll(
                /\r\n/g,
                ''
              )),
        ...
        return e.para.app_js_bridge.is_send
          ...
          : (t.isFunction(s) && s(), i.cancellationToken.cancel(), r)
      }
      return (
        window.SensorsDataWebJSSDKPlugin &&
        '[object Object]' === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin)
