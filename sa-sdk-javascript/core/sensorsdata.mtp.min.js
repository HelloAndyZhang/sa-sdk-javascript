!(function (e, t) {
  ...
  function f(e) {
    ...
    return (
      ...
      (t.prototype._parse = function (e) {
        ...
        t || _r.log('URLParser::_parse -> Invalid URL')
        var r = e.split('#'),
          n = r[0],
          i = r.slice(1).join('#')
  ...
  function _(e) {
    ...
    if ('function' == typeof window.URL && r())
      ...
      var n = /^https?:\/\/.+/
      if (n.test(e) === !1) return void _r.log('Invalid URL')
      var i = f(e)
      ...
      var a = function (a) {
        if ((a = a || i(window.event))) {
          ...
          return (
            ...
            (s = t.call(e, a)),
            'beforeunload' !== n ? ((!1 !== o && !1 !== s) || (c = !1), c) : void 0
          )
        }
      }
      return a
  ...
  function k(e, t, r) {
    if (null == e) return !1
    if (br && e.forEach === br) e.forEach(t, r)
    else if (v(e)) for (var n = 0, i = e.length; n < i; n++) n in e && t.call(r, e[n], n, e)
    else for (var a in e) wr.call(e, a) && t.call(r, e[a], a, e)
  }
  function $(e) {
    return (
      k(Array.prototype.slice.call(arguments, 1), function (t) {
        for (var r in t) Sr.call(t, r) && void 0 !== t[r] && (e[r] = t[r])
      }),
      e
    )
  }
  function P(e) {
    ...
    e.type || (e.type = e.data ? 'POST' : 'GET'),
      (e = $({ success: function () {}, error: function () {} }, e))
    var a,
      o = e.success,
      s = e.error
  ...
  function x(e, t) {
    ...
    var r = !1,
      ...
      u = function (n) {
        ;('readystatechange' == n.type && 'complete' != i.readyState) ||
          (('load' == n.type ? t : i)[c](l + n.type, u, !1),
    ...
    if ('complete' == i.readyState) e.call(t, 'lazy')
      ...
      i[s](l + 'DOMContentLoaded', u, !1),
        i[s](l + 'readystatechange', u, !1),
        t[s](l + 'load', u, !1)
    }
  }
  function T(e) {
  ...
  function se(e) {
    ...
    var t = /^https?:\/\/.+/
    return t.test(e) !== !1 || (_r.log('Invalid URL'), !1)
  }
  function ce() {
  ...
  function fe(t) {
    if (!r(t) || !p(t.callbackName))
      return _r.log('JSONP \u8bf7\u6c42\u7f3a\u5c11 callbackName'), !1
  ...
  function we(e) {
    if ('string' != typeof e) return _r.log('\u8f6c\u6362unicode\u9519\u8bef', e), e
  ...
  function Se(e, r, n) {
    ...
    return function () {
      ...
      return (
        ...
        (a = arguments),
        p <= 0 || p > r
          ? (s && (clearTimeout(s), (s = null)), (c = u), (o = e.apply(i, a)), s || (i = a = null))
          : s || n.trailing === !1 || (s = setTimeout(l, p)),
        o
      )
    }
  }
  ...
  function Ne() {
    if (
      ((Pr.isSupport() && 'true' === sessionStorage.getItem('sensorsdata_jssdk_debug')) ||
        Tr.show_log) &&
      (!r(arguments[0]) ||
        (Tr.show_log !== !0 && 'string' !== Tr.show_log && Tr.show_log !== !1) ||
  ...
  function Ce(e) {
    return (
      0 === e.indexOf(Dr)
        ? ((e = e.substring(Dr.length)), (e = ve(e)))
        : 0 === e.indexOf(Ar) && ((e = e.substring(Ar.length)), (e = D(e))),
      e
    )
  }
  function Oe(e) {
    return !p(e) || (0 !== e.indexOf(Dr) && 0 !== e.indexOf(Ar)) || (e = Ce(e)), e
  }
  function xe(e) {
    return Ar + D(e)
  }
  ...
  function Le() {
    ...
    return oe(e) || !e.eqid ? mr().replace(/-/g, '') : e.eqid
  }
  function Ue() {
    var e = W(document.referrer)
    if (oe(e) || !e.eqid) {
  ...
  function Re(e) {
    return (e = e || document.referrer), '' === e || q(B(e), Ur) !== q(null, Ur)
  }
  function Je(e, t) {
    return (
      ...
      'string' != typeof e
        ...
        : ((e = d(e)),
          ...
          (e = e.slice(0, Tr.max_referrer_string_length)),
          'string' == typeof e ? e : '')
    )
  }
  function qe(e) {
  ...
  function He(e, t) {
    e = e || document.referrer
    var r = Tr.source_type.keyword
    if (document && 'string' == typeof e) {
      if (0 === e.indexOf('http')) {
        var n = qe(e),
          i = W(e)
        if (oe(i))
          return Tr.preset_properties.search_keyword_baidu && Ie()
            ? void 0
            : '\u672a\u53d6\u5230\u503c'
        var a = null
        for (var o in r)
  ...
  function Be() {
    ...
    var t = '(' + Tr.source_type.utm.join('|') + ')\\=[^&]+',
      r = Tr.source_type.search,
      n = Tr.source_type.social,
      i = document.referrer || '',
      a = qr.pageProp.url
    if (a) {
  ...
  function Ke(e) {
    var t =
      Tr.heatmap && 'function' == typeof Tr.heatmap.collect_input && Tr.heatmap.collect_input(e)
  ...
  function We(e) {
    return Er.protocol.ajax(e.url), P(e)
  }
  function ze(e, t, n) {
    var i = !(!r(Tr.heatmap) || !Tr.heatmap.useCapture)
    return (
      r(Tr.heatmap) && 'undefined' == typeof Tr.heatmap.useCapture && 'click' === t && (i = !0),
      b(e, t, n, i)
    )
  }
  function Ve() {
  ...
  function Xe(e, t) {
    var r = ''
    if (((t = t || location.href), Tr.cross_subdomain === !1)) {
      try {
        r = _(t).hostname
      } catch (n) {
        Ne(n)
      ...
      r =
        'string' == typeof r && '' !== r
          ? 'sajssdk_2015_' + Tr.sdk_id + e + '_' + r.replace(/\./g, '_')
          : 'sajssdk_2015_root_' + Tr.sdk_id + e
    } else r = 'sajssdk_2015_cross_' + Tr.sdk_id + e
    return r
  }
  function Ze() {
    var e = 'new_user'
    return Hr.isSupport()
      ? null !== Hr.get('sensorsdata_is_new_user') || null !== Hr.get(Xe(e))
      : null !== Mr.get(Mr.getNewUserFlagMemoryKey(e))
  }
  function Ye(e, t) {
    for (var r in e)
      if (Object.prototype.hasOwnProperty.call(e, r) && !zr.check(r, e[r], t)) return !1
    return !0
  }
  function Ge(e) {
    return Vr.stage.process('addCustomProps', e)
  }
  function Qe(e) {
  ...
  function tt(e, t) {
    var r = []
    'string' == typeof e && e in tn.EVENT_LIST && ((r = tn.EVENT_LIST[e]), tn[r[0]].on(r[1], t))
  }
  function rt(e) {
    ...
    r(e.properties) &&
      (e.properties.$first_referrer &&
        (e.properties.$first_referrer_host = B(e.properties.$first_referrer, n)),
      t &&
        ('$referrer' in e.properties &&
          (e.properties.$referrer_host =
            '' === e.properties.$referrer ? '' : B(e.properties.$referrer, n)),
        dr.para.preset_properties.latest_referrer &&
          dr.para.preset_properties.latest_referrer_host &&
          (e.properties.$latest_referrer_host =
            '' === e.properties.$latest_referrer ? '' : B(e.properties.$latest_referrer, n))))
  }
  function nt(e) {
    var t = !e.type || 'profile' !== e.type.slice(0, 7),
      r = dr.para.preset_properties && t
    r &&
      dr.para.preset_properties.url &&
      'undefined' == typeof e.properties.$url &&
      (e.properties.$url = Z()),
      r &&
        dr.para.preset_properties.title &&
        'undefined' == typeof e.properties.$title &&
        (e.properties.$title = document.title)
  }
  function it(e) {
    $(Tr, e || dr.para || {}), (dr.para = Tr)
    var t = {}
    if (r(dr.para.is_track_latest))
      for (var n in dr.para.is_track_latest) t['latest_' + n] = dr.para.is_track_latest[n]
    dr.para.preset_properties = $(
      {},
      dr.para_default.preset_properties,
      t,
      dr.para.preset_properties || {}
    )
    var i
    for (i in dr.para_default) void 0 === dr.para[i] && (dr.para[i] = dr.para_default[i])
    'string' == typeof dr.para.server_url &&
      ((dr.para.server_url = d(dr.para.server_url)),
      dr.para.server_url &&
        ('://' === dr.para.server_url.slice(0, 3)
          ? (dr.para.server_url = location.protocol.slice(0, -1) + dr.para.server_url)
          : '//' === dr.para.server_url.slice(0, 2)
          ? (dr.para.server_url = location.protocol + dr.para.server_url)
          : 'http' !== dr.para.server_url.slice(0, 4) && (dr.para.server_url = ''))),
      'string' != typeof dr.para.web_url ||
        ('://' !== dr.para.web_url.slice(0, 3) && '//' !== dr.para.web_url.slice(0, 2)) ||
        ('://' === dr.para.web_url.slice(0, 3)
          ? (dr.para.web_url = location.protocol.slice(0, -1) + dr.para.web_url)
          : (dr.para.web_url = location.protocol + dr.para.web_url)),
      'image' !== dr.para.send_type &&
        'ajax' !== dr.para.send_type &&
        'beacon' !== dr.para.send_type &&
        (dr.para.send_type = 'image'),
      dr.debug.protocol.serverUrl(),
      dr.bridge.initPara()
    var a = { datasend_timeout: 6e3, send_interval: 6e3 }
    hr.isSupport() && de() && 'object' == typeof localStorage
      ? dr.para.batch_send === !0
        ? (dr.para.batch_send = $({}, a))
        : 'object' == typeof dr.para.batch_send &&
          (dr.para.batch_send = $({}, a, dr.para.batch_send))
      : (dr.para.batch_send = !1)
    ...
    'object' == typeof dr.para.source_type &&
      ((dr.para.source_type.utm = v(dr.para.source_type.utm)
        ? dr.para.source_type.utm.concat(o)
        : o),
      (dr.para.source_type.search = v(dr.para.source_type.search)
        ? dr.para.source_type.search.concat(s)
        : s),
      (dr.para.source_type.social = v(dr.para.source_type.social)
        ? dr.para.source_type.social.concat(c)
        : c),
      (dr.para.source_type.keyword = r(dr.para.source_type.keyword)
        ? $(l, dr.para.source_type.keyword)
        : l))
    var u = { div: !1 },
      p = ['mark', '/mark', 'strong', 'b', 'em', 'i', 'u', 'abbr', 'ins', 'del', 's', 'sup']
    if ((dr.para.heatmap && !r(dr.para.heatmap) && (dr.para.heatmap = {}), r(dr.para.heatmap))) {
      ;(dr.para.heatmap.clickmap = dr.para.heatmap.clickmap || 'default'),
        (dr.para.heatmap.scroll_notice_map = dr.para.heatmap.scroll_notice_map || 'default'),
        (dr.para.heatmap.scroll_delay_time = dr.para.heatmap.scroll_delay_time || 4e3),
        (dr.para.heatmap.scroll_event_duration = dr.para.heatmap.scroll_event_duration || 18e3),
        (dr.para.heatmap.renderRefreshTime = dr.para.heatmap.renderRefreshTime || 1e3),
        (dr.para.heatmap.loadTimeout = dr.para.heatmap.loadTimeout || 1e3),
        dr.para.heatmap.get_vtrack_config !== !0 && (dr.para.heatmap.get_vtrack_config = !1)
      var f = v(dr.para.heatmap.track_attr)
        ? U(dr.para.heatmap.track_attr, function (e) {
            return e && 'string' == typeof e
          })
        : []
      if (
        (f.push('data-sensors-click'),
        (dr.para.heatmap.track_attr = f),
        r(dr.para.heatmap.collect_tags))
      )
        if (dr.para.heatmap.collect_tags.div === !0)
          dr.para.heatmap.collect_tags.div = { ignore_tags: p, max_level: 1 }
        else if (r(dr.para.heatmap.collect_tags.div)) {
          if (
            (dr.para.heatmap.collect_tags.div.ignore_tags
              ? v(dr.para.heatmap.collect_tags.div.ignore_tags) ||
                (dr.log('ignore_tags \u53c2\u6570\u5fc5\u987b\u662f\u6570\u7ec4\u683c\u5f0f'),
                (dr.para.heatmap.collect_tags.div.ignore_tags = p))
              : (dr.para.heatmap.collect_tags.div.ignore_tags = p),
            dr.para.heatmap.collect_tags.div.max_level)
          ) {
            var _ = [1, 2, 3]
            re(_, dr.para.heatmap.collect_tags.div.max_level) === -1 &&
              (dr.para.heatmap.collect_tags.div.max_level = 1)
          }
        } else dr.para.heatmap.collect_tags.div = !1
      else dr.para.heatmap.collect_tags = u
    }
    if (v(dr.para.server_url) && dr.para.server_url.length)
      for (i = 0; i < dr.para.server_url.length; i++)
        /sa\.gif[^\/]*$/.test(dr.para.server_url[i]) ||
          (dr.para.server_url[i] = dr.para.server_url[i]
            .replace(/\/sa$/, '/sa.gif')
            .replace(/(\/sa)(\?[^\/]+)$/, '/sa.gif$2'))
    else
      /sa\.gif[^\/]*$/.test(dr.para.server_url) ||
        'string' != typeof dr.para.server_url ||
        (dr.para.server_url = dr.para.server_url
          .replace(/\/sa$/, '/sa.gif')
          .replace(/(\/sa)(\?[^\/]+)$/, '/sa.gif$2'))
    'string' == typeof dr.para.server_url &&
      (dr.para.debug_mode_url =
        dr.para.debug_mode_url || dr.para.server_url.replace('sa.gif', 'debug')),
      dr.para.noCache === !0
        ? (dr.para.noCache = '?' + new Date().getTime())
        : (dr.para.noCache = ''),
      dr.para.callback_timeout > dr.para.datasend_timeout &&
        (dr.para.datasend_timeout = dr.para.callback_timeout),
      dr.para.heatmap &&
        dr.para.heatmap.collect_tags &&
        r(dr.para.heatmap.collect_tags) &&
        k(dr.para.heatmap.collect_tags, function (e, t) {
          'div' !== t && e && dr.heatmap.otherTags.push(t)
        }),
      dr.para.heatmap && 'default' === dr.para.heatmap.clickmap && dr.heatmap.initUnlimitedTags()
  }
  function at(e) {
    var t = {}
    for (var r in e) t[r] = e[r]
    ;(dr.store._state.identities = t), dr.store.save()
  }
  function ot() {
    ;(dr._t = dr._t || 1 * new Date()),
      (dr.lib_version = Lr),
      (dr.is_first_visitor = !1),
      (dr.source_channel_standard = Ir)
  }
  function st() {
    if (Pr.isSupport())
      try {
        ...
        dr.log('enableLocalLog error: ' + e.message)
      }
  }
  function ct() {
    Pr.isSupport() && sessionStorage.removeItem('sensorsdata_jssdk_debug')
  }
  function lt() {
  ...
  function ut(t, n) {
    return p(t)
      ? r(window.SensorsDataWebJSSDKPlugin) &&
        ...
        ? (window.SensorsDataWebJSSDKPlugin[t].init(dr, n), window.SensorsDataWebJSSDKPlugin[t])
        : r(dr.modules) && r(dr.modules[t]) && e(dr.modules[t].init)
        ? (dr.modules[t].init(dr, n), dr.modules[t])
        : void dr.log(
            t +
              '\u6ca1\u6709\u83b7\u53d6\u5230,\u8bf7\u67e5\u9605\u6587\u6863\uff0c\u8c03\u6574' +
              t +
      ...
      : (dr.log('use\u63d2\u4ef6\u540d\u79f0\u5fc5\u987b\u662f\u5b57\u7b26\u4e32\uff01'), !1)
  }
  function pt(e, t, r) {
    Xr.check({ event: e, properties: t }) && Xr.send({ type: 'track', event: e, properties: t }, r)
  }
  function dt(e, t) {
    return (
      !!Xr.check({ bindKey: e, bindValue: t }) &&
      ((dr.store._state.identities[e] = t),
      dr.store.save(),
      void Xr.send({ type: 'track_id_bind', event: '$BindID', properties: {} }))
    )
  }
  function ft(e, t) {
    if (!Xr.check({ unbindKey: e, bindValue: t })) return !1
    if (
      r(dr.store._state.identities) &&
      dr.store._state.identities.hasOwnProperty(e) &&
      dr.store._state.identities[e] === t
    ) {
      var n = dr.store.getUnionId().login_id
      n &&
        e + '+' + t === n &&
        ((dr.store._state.distinct_id = dr.store._state.first_id),
        (dr.store._state.first_id = ''),
        dr.store.set('history_login_id', { name: '', value: '' })),
        '$identity_cookie_id' !== e && (delete dr.store._state.identities[e], dr.store.save())
    }
    var i = {}
    ;(i[e] = t),
      Xr.send({ identities: i, type: 'track_id_unbind', event: '$UnbindID', properties: {} })
  }
  function _t(e, t, r) {
    function n(e, t, r) {
      function n(e) {
        ...
        var a = !1
        setTimeout(n, 1e3), dr.track(t, r, n)
      }
      e = e || {}
      var i = null
      return (
  ...
  function ht(e, t, r) {
    return (
      ...
      !(!e || 'object' != typeof e) &&
        ...
        void ze(e, 'click', function (n) {
          function i() {
            a || ((a = !0), (location.href = e.href))
          }
          n.preventDefault()
          var a = !1
          setTimeout(i, 1e3), dr.track(t, r, i)
        })
    )
  }
  function gt(e, t, r) {
    Xr.check({ item_type: e, item_id: t, properties: r }) &&
      Xr.sendItem({ type: 'item_set', item_type: e, item_id: t, properties: r || {} })
  }
  function mt(e, t) {
    Xr.check({ item_type: e, item_id: t }) &&
      Xr.sendItem({ type: 'item_delete', item_type: e, item_id: t })
  }
  function vt(e, t) {
    Xr.check({ propertiesMust: e }) && Xr.send({ type: 'profile_set', properties: e }, t)
  }
  function yt(e, t) {
    Xr.check({ propertiesMust: e }) && Xr.send({ type: 'profile_set_once', properties: e }, t)
  }
  function bt(e, t) {
    Xr.check({ propertiesMust: e }) &&
      (k(e, function (t, r) {
        p(t)
          ? (e[r] = [t])
          : v(t)
      ...
      oe(e) || Xr.send({ type: 'profile_append', properties: e }, t))
  }
  function wt(e, t) {
    function r(e) {
      for (var t in e)
    ...
    p(e) && ((e = {}), (e[n] = 1)),
      Xr.check({ propertiesMust: e }) &&
        (r(e)
          ? Xr.send({ type: 'profile_increment', properties: e }, t)
          : dr.log('profile_increment\u7684\u503c\u53ea\u80fd\u662f\u6570\u5b57'))
  }
  function St(e) {
    Xr.send({ type: 'profile_delete' }, e), Kr.set('distinct_id', mr()), Kr.set('first_id', '')
  }
  function kt(e, t) {
    var r = e,
      n = {}
    p(e) && ((e = []), e.push(r)),
      v(e)
        ? (k(e, function (e) {
          ...
          Xr.send({ type: 'profile_unset', properties: n }, t))
        : dr.log('profile_unset\u7684\u53c2\u6570\u662f\u6570\u7ec4')
  }
  function $t(e, t) {
    function r(e) {
      ;(dr.store._state.identities.$identity_anonymous_id = e), dr.store.save()
    }
    'number' == typeof e && (e = String(e))
    var n = Kr.getFirstId()
    if ('undefined' == typeof e) {
      var i = mr()
      n ? Kr.set('first_id', i) : Kr.set('distinct_id', i), r(i)
    } else Xr.check({ distinct_id: e }) && (t === !0 ? (n ? Kr.set('first_id', e) : Kr.set('distinct_id', e)) : n ? Kr.change('first_id', e) : Kr.change('distinct_id', e), r(e))
  }
  function Pt(e, t, r, n) {
    var i = Kr.getFirstId() || Kr.getDistinctId()
    Kr.set('distinct_id', e),
      Xr.send(
        {
          original_id: i,
          distinct_id: dr.store.getDistinctId(),
          type: 'track_signup',
          event: t,
          properties: r
        },
  ...
  function Nt(e, t, r, n) {
    'number' == typeof e && (e = String(e)),
      Xr.check({ distinct_id: e, event: t, properties: r }) && Pt(e, t, r, n)
  }
  function Ct(e) {
    Xr.check({ properties: e })
      ? $(qr.currentProps, e)
      : dr.log('register\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function Ot(e) {
    Kr.clearAllProps(e)
  }
  function xt(e) {
    ...
    else if (e === !0) for (t in qr.currentProps) delete qr.currentProps[t]
  }
  function Tt(e) {
    Xr.check({ properties: e })
      ? Kr.setProps(e)
  ...
  function jt(e) {
    Xr.check({ properties: e })
      ? Kr.setPropsOnce(e)
      : dr.log('registerOnce\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function Dt(e) {
    Xr.check({ properties: e })
      ? Kr.setSessionProps(e)
      : dr.log('registerSession\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function At(e) {
    Xr.check({ properties: e })
      ? Kr.setSessionPropsOnce(e)
      : dr.log('registerSessionOnce\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function Et(e) {
    var t = e.id,
      n = e.callback,
      i = e.name,
      a = Kr.getFirstId(),
      o = Kr.getOriginDistinctId()
    if (!Xr.check({ distinct_id: t })) return dr.log('login id is invalid'), !1
    if (t === dr.store.getOriginDistinctId() && !a)
      return dr.log('login id is equal to distinct_id'), !1
    if (
      r(dr.store._state.identities) &&
      dr.store._state.identities.hasOwnProperty(i) &&
      t === dr.store._state.first_id
    )
      return !1
    var s =
      dr.store._state.history_login_id.name !== i || t !== dr.store._state.history_login_id.value
    if (s) {
      ;(dr.store._state.identities[i] = t),
        dr.store.set('history_login_id', { name: i, value: t }),
        a || Kr.set('first_id', o),
        Pt(t, '$SignUp', {}, n)
      var c = { $identity_cookie_id: dr.store._state.identities.$identity_cookie_id }
      return (c[i] = t), at(c), !0
    }
    return !1
  }
  function It(t, r) {
    ...
    var n = Et({ id: t, callback: r, name: Rr.LOGIN })
    !n && e(r) && r()
  }
  function Lt(e, t) {
    return (
      'number' == typeof t && (t = String(t)),
      'number' == typeof e && (e = String(e)),
      !!Xr.check({ loginIdKey: e }) &&
        (Rr.LOGIN === e ? (It(t), !1) : void Et({ id: t, callback: null, name: e }))
    )
  }
  function Ut(e) {
    var t = Kr.getFirstId()
    if (t)
      if ((Kr.set('first_id', ''), e === !0)) {
        var r = mr()
        Kr.set('distinct_id', r)
      } else Kr.set('distinct_id', t)
    at({ $identity_cookie_id: dr.store._state.identities.$identity_cookie_id }),
      dr.store.set('history_login_id', { name: '', value: '' })
  }
  function Rt() {
    function e() {
      ...
      return (
        k(e, function (e, r, n) {
          ;(' ' + dr.source_channel_standard + ' ').indexOf(' ' + r + ' ') !== -1
            ? (t['$' + r] = n[r])
            : (t[r] = n[r])
        }),
        t
    ...
    var t = {
        $is_first_day: Ze(),
        $is_first_time: Br.is_page_first_visited,
        $referrer: qr.pageProp.referrer || '',
        $referrer_host: qr.pageProp.referrer ? B(qr.pageProp.referrer) : '',
        $url: Z(),
        $url_path: Y(),
        $title: document.title || '',
        _distinct_id: Kr.getDistinctId(),
        identities: JSON.parse(JSON.stringify(Kr._state.identities))
      },
      r = $({}, qr.properties(), dr.store.getProps(), e(), t)
    return (
      dr.para.preset_properties.latest_referrer &&
        dr.para.preset_properties.latest_referrer_host &&
        (r.$latest_referrer_host = '' === r.$latest_referrer ? '' : B(r.$latest_referrer)),
      r
    )
  }
  function Jt() {
    ...
    dr.heatmap &&
      v(dr.heatmap.otherTags) &&
      k(dr.heatmap.otherTags, function (r) {
        e += r + t
      }),
      ce() &&
        K() &&
        ...
        (dr.para.heatmap &&
          dr.para.heatmap.collect_tags &&
          dr.para.heatmap.collect_tags.div &&
          be('div, [data-sensors-click]' + t),
        dr.para.heatmap &&
          dr.para.heatmap.track_attr &&
          be('[' + dr.para.heatmap.track_attr.join('], [') + ']' + t),
        '' !== e && be(e))
  }
  function qt() {
    return sn.stage && sn.stage.process('getUtmData')
  }
  function Ht(e, t) {
    var r = cn.encodeTrackData(t)
    return e.indexOf('?') !== -1 ? e + '&' + r : e + '?' + r
  }
  function Mt(e) {
    return cn.encodeTrackData(e)
  }
  function Bt(e) {
    var t = ['image', 'ajax', 'beacon'],
      r = t[0]
    return (
      (r = e.config && re(t, e.config.send_type) > -1 ? e.config.send_type : dr.para.send_type),
  ...
  function Wt() {
    k(_n, function (e) {
      var t = dr[e]
      dr[e] = function () {
        if (dr.readyState.state < 3) return v(dr._q) || (dr._q = []), dr._q.push([e, arguments]), !1
        {
          if (dr.readyState.getState()) return t.apply(dr, arguments)
          try {
  ...
  function zt() {
    dr.para.is_track_single_page &&
      Qr.on('switch', function (e) {
        var t = function (t) {
          ;(t = t || {}),
            e !== location.href &&
              ((qr.pageProp.referrer = Z(e)),
              dr.quick('autoTrack', $({ $url: Z(), $referrer: Z(e) }, t)))
        }
        if ('boolean' == typeof dr.para.is_track_single_page) t()
        else if ('function' == typeof dr.para.is_track_single_page) {
          var n = dr.para.is_track_single_page()
          r(n) ? t(n) : n === !0 && t()
        }
      })
  }
  function Vt() {
    dr._q &&
      ...
      dr._q.length > 0 &&
      k(dr._q, function (e) {
        dr[e[0]].apply(dr, Array.prototype.slice.call(e[1]))
      }),
      r(dr.para.heatmap) && (Yr.initHeatmap(), Yr.initScrollmap())
  }
  function Xt() {
    dr.readyState.setState(3), qr.initPage(), zt(), dr.store.init(), dr.readyState.setState(4), Vt()
  }
  function Zt(e) {
  ...
  function Qt(e) {
    e && e.dataStage && gn.registerStageImplementation(e.dataStage),
      e && e.businessStage && bn.registerStageImplementation(e.businessStage),
      e && e.sendStage && vn.registerStageImplementation(e.sendStage)
  }
  function er(e) {
    ;(e.kit = cn),
      (e.saEvent = Xr),
    ...
    r(e) &&
      k(e, function (i, a) {
        if (r(i)) ir(e[a])
          ...
          if (re(n, a) > -1) return
          e[a] = rr(i, re(t, a) > -1 ? 1024 : Tr.max_string_length)
        }
      })
  }
  function ar(e) {
  ...
  function cr(e) {
    var t = e.properties
    r(t) ? (tr(t), nr(t), ar(e), sr(t), ir(t)) : 'properties' in e && (e.properties = {}),
      ye(e),
      or(e)
  }
  function lr() {
  ...
  function ur(t, n) {
    if (!p(t))
      return Ne('use\u63d2\u4ef6\u540d\u79f0\u5fc5\u987b\u662f\u5b57\u7b26\u4e32\uff01'), !1
    if (
      r(window.SensorsDataWebJSSDKPlugin) &&
      r(window.SensorsDataWebJSSDKPlugin[t]) &&
      e(window.SensorsDataWebJSSDKPlugin[t].__constructor__)
    ) {
      var i = new window.SensorsDataWebJSSDKPlugin[t].__constructor__()
      return i.init(dr, n), i
    }
    Ne(t + '\u591a\u7248\u672c SDK\uff0c\u4e0d\u652f\u6301' + t + '\u63d2\u4ef6\uff01')
  }
  function pr() {}
  var dr = {}
  ;(function () {
    function e(n, i) {
      ...
      if ('object' == typeof h && h)
        return (i.stringify = h.stringify), (i.parse = h.parse), (i.runInContext = e), i
      var g,
        m = u.prototype,
        v = m.toString,
        y = m.hasOwnProperty,
      ...
      if (
            ...
            var E = '\\u00',
              ...
              R = function (e, t, r, n, i, o, s) {
                ...
                if (
                  ...
                  'object' == typeof c &&
                    c &&
                    (c.getUTCFullYear && v.call(c) == S && c.toJSON === p.prototype.toJSON
                      ? (c = D(c))
                ...
                if ('object' == typeof c) {
                  ...
                  if ((s.push(c), (d = []), (y = o), (o += i), u == P)) {
                    for (h = 0, m = c.length; h < m; h++)
                      (_ = R(h, c, r, n, i, o, s)), d.push(_ === g ? 'null' : _)
                    b = d.length
                      ? i
                        ? '[\n' + o + d.join(',\n' + o) + '\n' + y + ']'
                        : '[' + d.join(',') + ']'
              ...
              if (t[typeof r] && r)
                if (((s = v.call(r)), s == w)) a = r
                  ...
                  for (var c, l = 0, u = r.length; l < u; )
                    (c = r[l++]),
                      (s = v.call(c)),
                      ('[object String]' != s && '[object Number]' != s) || (o[c] = 1)
                }
              if (n)
                if (((s = v.call(n)), s == k)) {
        ...
        if (!o('json-parse')) {
          var J,
            ...
            K = function () {
              for (var e, t, r, n, i, a = q, o = a.length; J < o; )
                switch ((i = a.charCodeAt(J))) {
                  ...
                  case 58:
                  case 44:
                    return (e = C ? a.charAt(J) : a[J]), J++, e
                  case 34:
                    for (e = '@', J++; J < o; )
                      if (((i = a.charCodeAt(J)), i < 32)) B()
                      else if (92 == i)
                        switch ((i = a.charCodeAt(++J))) {
                          case 92:
                          case 34:
                        ...
                        if (34 == i) break
                        for (i = a.charCodeAt(J), t = J; i >= 32 && 92 != i && 34 != i; )
                          i = a.charCodeAt(++J)
                        e += a.slice(t, J)
                      }
                  ...
                  default:
                    if (
                      ((t = J), 45 == i && ((n = !0), (i = a.charCodeAt(++J))), i >= 48 && i <= 57)
                    ) {
                      for (
                        48 == i && ((i = a.charCodeAt(J + 1)), i >= 48 && i <= 57) && B(), n = !1;
                        J < o && ((i = a.charCodeAt(J)), i >= 48 && i <= 57);
                        J++
                      );
                      ...
                      if (((i = a.charCodeAt(J)), 101 == i || 69 == i)) {
                        for (
                          i = a.charCodeAt(++J), (43 != i && 45 != i) || J++, r = J;
            ...
            z = function (e, t, r) {
              ...
              if ('object' == typeof i && i)
                if (v.call(i) == P) for (n = i.length; n--; ) W(v, O, i, n, r)
                else
                  O(i, function (e) {
                    W(i, e, r)
                  })
  ...
  var fr,
    _r = {
      ...
      log: function () {
        ;(fr || (console && console.log) || function () {}).apply(null, arguments)
      }
    },
    hr = {
      get: function (e) {
      ...
      isSupport: function () {
        ...
        try {
          ...
          hr.set(t, r), hr.get(t) !== r && (e = !1), hr.remove(t)
        } catch (n) {
          e = !1
        }
        return e
  ...
  ;(a.prototype.get = function (e, r, a, o) {
    ...
    return c && ((c = i(c) || { randomNum: 0, expireTime: 0 }), c.expireTime > t())
      ? o(null)
      : (hr.set(s, JSON.stringify({ randomNum: l, expireTime: t() + r })),
        void setTimeout(function () {
          ;(c = i(hr.get(s)) || { randomNum: 0, expireTime: 0 }),
            c && c.randomNum === l ? (o(hr.get(e)), hr.remove(e), hr.remove(s)) : o(null)
        }, a))
  }),
    (a.prototype.set = function (e, r, a, o, s) {
      ...
      return l && ((l = i(l) || { randomNum: 0, expireTime: 0 }), l.expireTime > t())
        ...
        : (hr.set(c, JSON.stringify({ randomNum: u, expireTime: t() + a })),
          void setTimeout(function () {
            ;(l = i(hr.get(c)) || { randomNum: 0, expireTime: 0 }),
              l.randomNum === u
                ? hr.set(e, r) && s({ status: 'success' })
                : s({ status: 'fail', reason: 'This key is locked' })
          }, o))
    }),
  ...
  vr.prototype = {
    ...
    siblings: function () {
      return yr((this.ele.parentNode || {}).firstChild, this.ele)
    },
    children: function () {
      return yr(this.ele.firstChild)
    },
    parent: function () {
  ...
  var br = Array.prototype.forEach,
    ...
    kr = {
      ...
      set: function (e, t, r, n, i, a, o) {
        ...
        e && (_ = s(e)),
          t && (h = s(t)),
          c && (g = s(c)),
          _ && h && (document.cookie = _ + '=' + encodeURIComponent(h) + l + '; path=/' + g + d + u)
      },
      remove: function (e, t) {
        this.set(e, '1', -1, t)
      },
    ...
    Er = {
      ...
      protocol: {
        ...
        serverUrl: function () {
          p(Tr.server_url) &&
            '' !== Tr.server_url &&
            !this.protocolIsSame(Tr.server_url, location.href) &&
            Ne(
    ...
    Ir = 'utm_source utm_medium utm_campaign utm_content utm_term',
    Lr = '1.23.3',
    Ur = 'sensorsdata_domain_test',
    Rr = { EMAIL: '$identity_email', MOBILE: '$identity_mobile', LOGIN: '$identity_login_id' },
    Jr = {
      data: {},
      id: function () {
    ...
    qr = {
      initPage: function () {
        var e = Je(),
          t = Z(),
          r = Ae(t)
        r || Er.jssdkDebug('url_domain\u5f02\u5e38_' + t + '_' + r),
          (this.pageProp = {
            referrer: e,
            referrer_host: e ? B(e) : '',
            url: t,
      ...
      campaignParamsStandard: function (e, t) {
        ...
        return (
          k(r, function (r, a, o) {
            ;(' ' + Ir + ' ').indexOf(' ' + a + ' ') !== -1 ? (n[e + a] = o[a]) : (i[t + a] = o[a])
          }),
          { $utms: n, otherUtms: i }
        )
      },
    ...
    Hr = {
      ...
      set: function (e, t, r, n) {
        var i = ''
        if ((n = 'undefined' == typeof n ? Tr.cross_subdomain : n)) {
          var a = Ae(location.href)
          'url\u89e3\u6790\u5931\u8d25' === a && (a = ''), (i = a ? '; domain=' + a : '')
        }
        return kr.set(e, t, r, n, Tr.set_cookie_samesite, Tr.is_secure_cookie, i)
      },
      remove: function (e, t) {
        return (t = 'undefined' == typeof t ? Tr.cross_subdomain : t), kr.remove(e, t)
      },
      isSupport: function (e, t) {
        return (e = e || 'sajssdk_2015_cookie_access_test'), (t = t || '1'), kr.isSupport(e, t)
      }
    }
  Hr.getNewUser = Ze
  var Mr = {
      ...
      getNewUserFlagMemoryKey: function (e) {
        return 'sajssdk_2015_' + Tr.sdk_id + e
      }
    },
    Br = {
      ...
      setDeviceId: function (e) {
        var t = null,
          r = Hr.get('sensorsdata2015jssdkcross' + dr.para.sdk_id)
        r = Oe(r)
        var n = {}
        null != r && le(r) && ((n = JSON.parse(r)), n.$device_id && (t = n.$device_id)),
          (t = t || e),
          dr.para.cross_subdomain === !0
            ? dr.store.set('$device_id', t)
            : ((n.$device_id = t),
              (n = JSON.stringify(n)),
              dr.para.encrypt_cookie && (n = xe(n)),
              Hr.set('sensorsdata2015jssdkcross' + dr.para.sdk_id, n, null, !0)),
          dr.para.is_track_device_id && (qr.currentProps.$device_id = t)
      },
      storeInitCheck: function () {
        if (dr.is_first_visitor) {
          var e = new Date(),
            t = { h: 23 - e.getHours(), m: 59 - e.getMinutes(), s: 59 - e.getSeconds() }
          Hr.isSupport()
            ? Hr.set(Xe('new_user'), '1', 3600 * t.h + 60 * t.m + t.s + 's')
            : Mr.set(
                Mr.getNewUserFlagMemoryKey('new_user'),
                '1',
      ...
      checkIsFirstLatest: function () {
        ...
        if (
          (dr.para.preset_properties.search_keyword_baidu
            ? Re(document.referrer) &&
              (!Ie() || (r(n) && n.active)
                ? dr.store._state &&
                  dr.store._state.props &&
                  (dr.store._state.props.$search_keyword_id &&
                    delete dr.store._state.props.$search_keyword_id,
                  dr.store._state.props.$search_keyword_id_type &&
                    delete dr.store._state.props.$search_keyword_id_type,
                  dr.store._state.props.$search_keyword_id_hash &&
                    delete dr.store._state.props.$search_keyword_id_hash)
                : ((t.$search_keyword_id = Jr.id()),
                  (t.$search_keyword_id_type = Jr.type()),
            ...
            : dr.store._state &&
              ...
              dr.store._state.props.$search_keyword_id_hash &&
                delete dr.store._state.props.$search_keyword_id_hash),
          dr.store.save(),
          k(dr.para.preset_properties, function (n, i) {
            ...
            if (((i = i.slice(7)), n)) {
                ...
                switch (i) {
                  ...
                  case 'search_keyword':
                    He()
                      ...
                      : r(dr.store._state) &&
                        r(dr.store._state.props) &&
                        dr.store._state.props.$latest_search_keyword &&
                        delete dr.store._state.props.$latest_search_keyword
                    break
                  case 'landing_page':
            ...
            } else if ('utm' === i && dr.store._state && dr.store._state.props)
              for (var o in dr.store._state.props)
                (0 === o.indexOf('$latest_utm') ||
                  (0 === o.indexOf('_latest_') && o.indexOf('_latest_wx_ad_') < 0)) &&
                  delete dr.store._state.props[o]
            else if (
              dr.store._state &&
              dr.store._state.props &&
              '$latest_' + i in dr.store._state.props
            )
              delete dr.store._state.props['$latest_' + i]
            else if (
              'wx_ad_click_id' == i &&
              dr.store._state &&
              dr.store._state.props &&
              ...
              k(s, function (e) {
                e in dr.store._state.props && delete dr.store._state.props[e]
              })
            }
          }),
          dr.register(t),
          dr.para.preset_properties.latest_utm)
        ) {
          var i = qr.campaignParamsStandard('$latest_', '_latest_'),
            a = i.$utms,
            o = i.otherUtms
          oe(a) || dr.register(a), oe(o) || dr.register(o)
        }
      }
    },
    Kr = {
      ...
      getUnionId: function (e) {
        ...
        return (
          t.login_id &&
            ...
            this._state.history_login_id.name !== dr.IDENTITY_KEY.LOGIN &&
      ...
      set: function (e, t) {
        ...
        ;(this._state[e] = t),
          ...
          this.save(),
          'distinct_id' === e && r && dr.events.tempAdd('changeDistinctId', t)
      },
      change: function (e, t) {
        this._state['_' + e] = t
      },
      ...
      setProps: function (e, t) {
        ...
        for (var n in r)
          'string' == typeof r[n] && (r[n] = r[n].slice(0, dr.para.max_referrer_string_length))
        this.set('props', r)
      },
      ...
      sessionSave: function (e) {
        ...
        dr.para.encrypt_cookie && (t = xe(t)), Hr.set('sensorsdata2015session', t, 0)
      },
      save: function () {
        ...
        dr.para.encrypt_cookie && (t = xe(t)),
          Hr.set(this.getCookieName(), t, 73e3, dr.para.cross_subdomain)
      },
      getCookieName: function () {
        var e = ''
        if (dr.para.cross_subdomain === !1) {
          try {
          ...
          e =
            'string' == typeof e && '' !== e
              ? 'sa_jssdk_2015_' + dr.para.sdk_id + e.replace(/\./g, '_')
              : 'sa_jssdk_2015_root' + dr.para.sdk_id
        } else e = 'sensorsdata2015jssdkcross' + dr.para.sdk_id
        return e
      },
      init: function () {
        function e(e) {
          ...
          e.identities &&
            (0 === e.identities.indexOf('\n/')
              ...
              : (e.identities = i(C(e.identities))))
          var n = Kr.getOriginUnionId(e)
          e.identities && r(e.identities) && !oe(e.identities)
            ...
            : ((e.identities = {}),
              (e.identities.$identity_anonymous_id = n.anonymous_id),
              (e.identities.$identity_cookie_id = mr())),
        ...
        function t(e) {
          dr.store.set('distinct_id', e),
            dr.store.set('identities', { $identity_cookie_id: e }),
            dr.store.set('history_login_id', { name: '', value: '' })
        }
        ...
        var n,
          a,
          o = mr()
        Hr.isSupport() && ((n = Hr.get(this.getCookieName())), (n = Oe(n)), (a = i(n))),
          Hr.isSupport() && null !== n && le(n) && r(a) && (!r(a) || a.distinct_id)
            ? ((dr.store._state = $(e(a))), dr.store.save())
            : ((dr.is_first_visitor = !0), t(o)),
          Br.setDeviceId(o),
          Br.storeInitCheck(),
          Br.checkIsFirstLatest()
      },
      saveObjectVal: function (e, t) {
        p(t) || (t = JSON.stringify(t)), 1 == dr.para.encrypt_cookie && (t = xe(t)), hr.set(e, t)
      },
    ...
    Fr = {
      ...
      idLength: function (e) {
        Ne(e + ' length is longer than ' + Tr.max_id_length)
      },
      keyLength: function (e) {
        Ne(e + ' length is longer than ' + Tr.max_key_length)
      },
      stringLength: function (e) {
        Ne(e + ' length is longer than ' + Tr.max_string_length)
      },
      voidZero: function (e) {
        Ne(e + "'s is undefined")
      },
    ...
    Wr = {
      ...
      unbindReservedNames: ['$identity_anonymous_id', Rr.LOGIN],
      string: function (e) {
        return !!p(e)
      },
      emptyString: function (e) {
      ...
      idLength: function (e) {
        return !(!p(e) || e.length > Tr.max_id_length)
      },
      keyLength: function (e) {
        return !(!p(e) || e.length > Tr.max_key_length)
      },
      stringLength: function (e) {
        return !(!p(e) || e.length > Tr.max_string_length)
      },
      voidZero: function (e) {
        return void 0 !== e
      },
      ...
      reservedBind: function (e) {
        var t = Kr._state.history_login_id
    ...
    zr = {
      ...
      event: {
        ...
        onComplete: function (t, r, n) {
          return t || ('emptyString' === n && (r = 'eventName'), e(Fr[n]) && Fr[n](r)), !0
        }
      },
      propertyKey: {
        rules: ['string', 'emptyString', 'keyLength', 'regexTest'],
        onComplete: function (t, r, n) {
          return t || ('emptyString' === n && (r = 'Property key'), e(Fr[n]) && Fr[n](r)), !0
        }
      },
      propertyValue: {
        rules: ['voidZero'],
        onComplete: function (t, r, n) {
          return t || ((r = 'Property Value'), e(Fr[n]) && Fr[n](r)), !0
        }
      },
        ...
        return (
          r(t)
            ? k(t, function (t, r) {
                Ye({ propertyKey: r })
                var n = function (t, n, i) {
                  return t || ((n = r + "'s Value"), e(Fr[i]) && Fr[i](n)), !0
                }
      ...
      item_type: {
        rules: ['string', 'emptyString', 'keyLength', 'regexTest'],
        onComplete: function (t, r, n) {
          return t || ('emptyString' === n && (r = 'item_type'), e(Fr[n]) && Fr[n](r)), !0
        }
      },
      item_id: {
        rules: ['string', 'emptyString', 'stringLength'],
        onComplete: function (t, r, n) {
          return t || ('emptyString' === n && (r = 'item_id'), e(Fr[n]) && Fr[n](r)), !0
        }
      },
      loginIdKey: {
      ...
      bindKey: {
        ...
        onComplete: function (t, r, n) {
          return (
            (!t && ('emptyString' === n && (r = 'Key'), e(Fr[n]) && Fr[n](r), 'keyLength' === n)) ||
            t
          )
        }
      },
      ...
      bindValue: {
        ...
        onComplete: function (t, r, n) {
          return (
            (!t &&
              ('emptyString' === n && (r = 'Value'), e(Fr[n]) && Fr[n](r), 'idLength' === n)) ||
            t
          )
        }
      },
    ...
    Xr = {}
  ;(Xr.check = Ye),
    (Xr.sendItem = function (e) {
      var t = {
        lib: { $lib: 'js', $lib_method: 'code', $lib_version: String(dr.lib_version) },
        time: 1 * new Date()
      }
      $(t, e), Vr.stage.process('formatData', t), dr.sendState.getSendCall(t)
    }),
    (Xr.send = function (e, t) {
      var r = dr.kit.buildData(e)
      dr.kit.sendData(r, t)
    }),
    (Xr.debugPath = function (e) {
      var t = e,
        r = ''
      ;(r =
        dr.para.debug_mode_url.indexOf('?') !== -1
          ? dr.para.debug_mode_url + '&' + dr.kit.encodeTrackData(e)
          : dr.para.debug_mode_url + '?' + dr.kit.encodeTrackData(e)),
        We({
          url: r,
          type: 'GET',
          cors: !0,
          header: { 'Dry-Run': String(dr.para.debug_mode_upload) },
          success: function (e) {
            oe(e) === !0
              ? alert('debug\u6570\u636e\u53d1\u9001\u6210\u529f' + t)
  ...
  var Zr = { label: !1, li: !1, a: !0, button: !0 },
    Yr = {
      otherTags: [],
      initUnlimitedTags: function () {
        k(Yr.otherTags, function (e) {
          e in Zr && (Zr[e] = !0)
        })
      },
      isUnlimitedTag: function (e) {
        ...
        return Zr[t] || Q(e, dr.para.heatmap.track_attr)
      },
      getTargetElement: function (e, t) {
        ...
        if (
          ...
          return y(a).prev()
        if ('div' === i && dr.para.heatmap.collect_tags.div && r.isDivLevelValid(n)) {
          var s =
            (dr.para.heatmap &&
              dr.para.heatmap.collect_tags &&
              dr.para.heatmap.collect_tags.div &&
        ...
        if (r.isStyleTag(i) && dr.para.heatmap.collect_tags.div) {
      ...
      isDivLevelValid: function (e) {
        for (
          ...
          if (Yr.getDivLevels(r[n], e) > t) return !1
        return !0
      },
      ...
      getElementPosition: function (e, t, r) {
        ...
        var i = dr.heatmap.getClosestLi(e)
        if (!i) return null
        ...
        if (s > 1) {
          for (var l = 0; l < s; l++) {
            var u = dr.heatmap.getElementPath(o[l], r)
            u === t && c.push(o[l])
          }
          if (c.length > 1) return re(c, e)
        }
        return n(i)
      },
      setNotice: function (e) {
        ;(dr.is_heatmap_render_mode = !0),
          dr.para.heatmap ||
            (dr.errorMsg =
          ...
          dr.para.heatmap_url ||
            (dr.para.heatmap_url =
              Ve() + '//static.sensorsdata.cn/sdk/' + dr.lib_version + '/heatmap.min.js')
      },
      ...
      selector: function (e, t) {
        ...
        return e.getAttribute &&
          ...
          (!dr.para.heatmap ||
            (dr.para.heatmap && 'not_use_id' !== dr.para.heatmap.element_selector)) &&
          !t
          ? '#' + e.getAttribute('id')
      ...
      getDomSelector: function (e, t, r) {
        ...
        return e && 'body' !== n && 1 == e.nodeType
          ? (t.unshift(this.selector(e, r)),
            ...
            /^[A-Za-z][-A-Za-z0-9_:.]*$/.test(e.getAttribute('id')) &&
            dr.para.heatmap &&
            'not_use_id' !== dr.para.heatmap.element_selector &&
            !r
              ? t.join(' > ')
      ...
      getEleDetail: function (e) {
        ...
        ;(r.$element_selector = t ? t : ''),
          (r.$element_path = dr.heatmap.getElementPath(
            e,
            dr.para.heatmap && 'not_use_id' === dr.para.heatmap.element_selector
          ))
        var n = dr.heatmap.getElementPosition(
          e,
          r.$element_path,
          dr.para.heatmap && 'not_use_id' === dr.para.heatmap.element_selector
        )
      ...
      start: function (t, n, i, a, o) {
        ...
        if (
          dr.para.heatmap &&
          dr.para.heatmap.collect_element &&
          !dr.para.heatmap.collect_element(n)
        )
          return !1
        var l = this.getEleDetail(n)
        if (dr.para.heatmap && dr.para.heatmap.custom_property) {
          var u = dr.para.heatmap.custom_property(n)
          r(u) && (l = $(l, u))
        }
        ;(l = $(l, this.getPointerEventProp(t, n), s)),
          'a' === i && dr.para.heatmap && dr.para.heatmap.isTrackLink === !0
            ? dr.trackLink({ event: t, target: n }, '$WebClick', l)
            : dr.track('$WebClick', l, c)
      },
      ...
      isStyleTag: function (e, t) {
        ...
        return (
          !(re(n, e) > -1) &&
          (!t ||
          (dr.para.heatmap && dr.para.heatmap.collect_tags && dr.para.heatmap.collect_tags.div)
            ? !!(
                r(dr.para.heatmap) &&
                r(dr.para.heatmap.collect_tags) &&
                r(dr.para.heatmap.collect_tags.div) &&
                v(dr.para.heatmap.collect_tags.div.ignore_tags) &&
                re(dr.para.heatmap.collect_tags.div.ignore_tags, e) > -1
              )
            : re(i, e) > -1)
        )
      },
      ...
      listenUrlChange: function (e) {
        e(),
          dr.ee.spa.on('switch', function () {
            e()
          })
      },
      initScrollmap: function () {
        if (!r(dr.para.heatmap) || 'default' !== dr.para.heatmap.scroll_notice_map) return !1
        var t = !0
        dr.para.scrollmap &&
          e(dr.para.scrollmap.collect_url) &&
          this.listenUrlChange(function () {
            t = !!dr.para.scrollmap.collect_url()
          })
        var n = function (e) {
            var t = {}
            return (
          ...
          i = n({
            ...
            func: function (e, t) {
              ...
              ;((i > dr.para.heatmap.scroll_delay_time && r - e.$viewport_position !== 0) || t) &&
                ((e.$url = Z()),
                (e.$title = document.title),
                (e.$url_path = Y()),
                (e.event_duration = Math.min(
                  dr.para.heatmap.scroll_event_duration,
                  parseInt(i) / 1e3
                )),
        ...
        ;(i.current_time = new Date()),
          ze(window, 'scroll', function () {
            return !!t && void i.go()
          }),
          ze(window, 'unload', function () {
      ...
      initHeatmap: function () {
        var t = this,
          n = !0
        return (
          !(!r(dr.para.heatmap) || 'default' !== dr.para.heatmap.clickmap) &&
          (e(dr.para.heatmap.collect_url) &&
            this.listenUrlChange(function () {
              n = !!dr.para.heatmap.collect_url()
            }),
          'all' === dr.para.heatmap.collect_elements
            ? (dr.para.heatmap.collect_elements = 'all')
            : (dr.para.heatmap.collect_elements = 'interact'),
          void ('all' === dr.para.heatmap.collect_elements
            ? ze(document, 'click', function (e) {
                if (!n) return !1
            ...
            : ze(document, 'click', function (e) {
                ...
                var a = i.target || i.srcElement,
                  o = dr.heatmap.getTargetElement(a, e)
                o
                  ? t.start(i, o, o.tagName.toLowerCase())
                  : h(a) &&
                    'div' === a.tagName.toLowerCase() &&
                    r(dr.para.heatmap) &&
                    dr.para.heatmap.get_vtrack_config &&
                    dr.unlimitedDiv.events.length > 0 &&
                    dr.unlimitedDiv.isTargetEle(a) &&
    ...
    Gr = {
      setOnlineState: function (e) {
        if (e === !0 && r(dr.para.jsapp) && 'function' == typeof dr.para.jsapp.getData) {
          dr.para.jsapp.isOnline = !0
          var t = dr.para.jsapp.getData()
          v(t) &&
            t.length > 0 &&
            k(t, function (e) {
              le(e) && dr.sendState.realtimeSend(JSON.parse(e))
            })
        } else dr.para.jsapp.isOnline = !1
      },
      autoTrackIsUsed: !1,
      isReady: function (e) {
        e()
      ...
      getStayTime: function () {
        return (new Date() - dr._t) / 1e3
      },
      setProfileLocal: function (e) {
        if (!hr.isSupport()) return dr.setProfile(e), !1
        if (!r(e) || oe(e)) return !1
        var t = dr.store.readObjectVal('sensorsdata_2015_jssdk_profile'),
          n = !1
        if (r(t) && !oe(t)) {
          for (var i in e) (!(i in t && t[i] !== e[i]) && i in t) || ((t[i] = e[i]), (n = !0))
          n && (dr.store.saveObjectVal('sensorsdata_2015_jssdk_profile', t), dr.setProfile(e))
        } else dr.store.saveObjectVal('sensorsdata_2015_jssdk_profile', e), dr.setProfile(e)
      },
      setInitReferrer: function () {
        var e = Je()
        dr.setOnceProfile({ _init_referrer: e, _init_referrer_host: qr.pageProp.referrer_host })
      },
      setSessionReferrer: function () {
        var e = Je()
        dr.store.setSessionPropsOnce({
          _session_referrer: e,
      ...
      trackHeatMap: function (e, t, r) {
        if ('object' == typeof e && e.tagName) {
          var n = e.tagName.toLowerCase(),
            ...
            a =
              dr.para.heatmap && dr.para.heatmap.track_attr
                ? dr.para.heatmap.track_attr
                : ['data-sensors-click']
          'button' === n ||
            'a' === n ||
      ...
      autoTrackSinglePage: function (e, t) {
        ...
        function i(e, t) {
          dr.track(
            '$pageview',
            $({ $referrer: a, $url: Z(), $url_path: Y(), $title: document.title }, e, n()),
            t
          ),
            (a = Z())
        }
        ...
        if (
          ...
          dr.is_first_visitor && o)
        ) {
          var s = {}
          dr.para.preset_properties.search_keyword_baidu &&
            Re(document.referrer) &&
            Ie() &&
            ((s.$search_keyword_id = Jr.id()),
            (s.$search_keyword_id_type = Jr.type()),
            (s.$search_keyword_id_hash = te(s.$search_keyword_id))),
            dr.setOnceProfile(
              $(
                {
      ...
      autoTrack: function (e, t) {
        e = r(e) ? e : {}
        var n = qr.campaignParams(),
          i = {}
        k(n, function (e, t, r) {
          ;(' ' + dr.source_channel_standard + ' ').indexOf(' ' + t + ' ') !== -1
            ? (i['$' + t] = r[t])
            : (i[t] = r[t])
        })
        ...
        var o = location.href
        if (
          (dr.para.is_single_page &&
            w(function () {
              var r = Je(o, !0)
              dr.track(
                '$pageview',
                $({ $referrer: r, $url: Z(), $url_path: Y(), $title: document.title }, i, e),
                t
              ),
                (o = Z())
            }),
          dr.track(
            '$pageview',
            $({ $referrer: Je(null, !0), $url: Z(), $url_path: Y(), $title: document.title }, i, e),
            t
          ),
          dr.is_first_visitor && a)
        ) {
          var s = {}
          dr.para.preset_properties.search_keyword_baidu &&
            Re(document.referrer) &&
      ...
      getAnonymousID: function () {
        return oe(dr.store._state)
          ? '\u8bf7\u5148\u521d\u59cb\u5316SDK'
          : dr.store._state._first_id ||
              dr.store._state.first_id ||
              dr.store._state._distinct_id ||
              dr.store._state.distinct_id
      },
  ...
  var rn = {
    ...
    nn = {
      ...
      loginWithKey: Lt,
      logout: Ut,
      getPresetProperties: Rt,
      iOSWebClickPolyfill: Jt,
      readyState: rn,
      para_default: jr,
      log: Ne,
      debug: Er,
  ...
  var on = {
      __proto__: null,
      parseSuperProperties: Te,
      searchConfigData: je,
      strip_empty_properties: De,
      getCurrentDomain: Ae,
      getEleInfo: Ee,
      isBaiduTraffic: Ie,
      getReferrerEqid: Le,
      ...
      getWxAdIdFromUrl: Me,
      getReferSearchEngine: qe,
      getSourceFromReferrer: Be,
      info: qr,
      ajax: We,
      getElementContent: Fe,
      cookie: Hr,
      addEvent: ze,
      EventEmitterSa: an,
      encrypt: xe,
  ...
  ;(cn.buildData = function (e) {
    var t = {
      ...
      lib: {
        $lib: 'js',
        $lib_method: 'code',
        $lib_version: String(dr.lib_version)
      },
      properties: {}
    }
    return (
      r(e) && r(e.identities) && !oe(e.identities)
        ? $(t.identities, e.identities)
        : $(t.identities, Kr._state.identities),
      r(e) &&
        r(e.properties) &&
        !oe(e.properties) &&
      ...
      $(t, dr.store.getUnionId(), e),
      Ge(t),
      r(e.properties) && !oe(e.properties) && $(t.properties, e.properties),
      (e.type && 'profile' === e.type.slice(0, 7)) ||
        ...
        dr.para.preset_properties.latest_search_keyword &&
        ...
        dr.para.preset_properties.latest_traffic_source_type &&
          !p(t.properties.$latest_traffic_source_type) &&
          (t.properties.$latest_traffic_source_type = '\u53d6\u503c\u5f02\u5e38'),
        dr.para.preset_properties.latest_landing_page &&
          !p(t.properties.$latest_landing_page) &&
          (t.properties.$latest_landing_page = '\u53d6\u503c\u5f02\u5e38'),
        'not_collect' === dr.para.preset_properties.latest_wx_ad_click_id
          ...
          : dr.para.preset_properties.latest_wx_ad_click_id &&
      ...
      t.properties.$time && A(t.properties.$time)
        ...
        : (t.time = 1 * new Date()),
      dr.vtrackBase.addCustomProps(t),
      Te(t),
      Br.checkIsAddSign(t),
      Br.checkIsFirstTime(t),
      dr.addReferrerHost(t),
      dr.addPropsHook(t),
      Qe(t),
      t
    )
  }),
    (cn.sendData = function (e, t) {
      var r = je(e.properties)
      dr.para.debug_mode === !0
        ? (dr.log(e), dr.saEvent.debugPath(JSON.stringify(e), t))
        : dr.sendState.getSendCall(e, r, t)
    }),
    (cn.encodeTrackData = function (e) {
      var t = O(e),
        r = 'crc=' + ee(t)
      return 'data=' + encodeURIComponent(t) + '&ext=' + encodeURIComponent(r)
    }),
    (cn.getUtmData = function () {
      return qt()
    })
  var ln = function (e) {
    ;(this.callback = e.callback),
      ...
      (this.img.width = 1),
      (this.img.height = 1),
      dr.para.img_use_crossorigin && (this.img.crossOrigin = 'anonymous'),
      (this.data = e.data),
  ...
  ;(ln.prototype.start = function () {
    ...
    (ln.prototype.lastClear = function () {
      var e = X()
      void 0 !== e.ie ? (this.img.src = 'about:blank') : (this.img.src = '')
    })
  var un = function (e) {
    ;(this.callback = e.callback), (this.server_url = e.server_url), (this.data = Mt(e.data))
  }
  un.prototype.start = function () {
    ...
    We({
      ...
      data: this.data,
      credentials: !1,
      timeout: dr.para.datasend_timeout,
      cors: !0,
      success: function () {
        e.isEnd()
      },
  ...
  var dn = {
    ...
    fn = {}
  ;(fn.getSendCall = function (e, t, r) {
    if (dr.is_heatmap_render_mode) return !1
    if (dr.readyState.state < 3) return dr.log('\u521d\u59cb\u5316\u6ca1\u6709\u5b8c\u6210'), !1
    ;(e._track_id = Number(
    ...
    return (
      dr.events.tempAdd('send', i),
      !dr.para.app_js_bridge && dr.para.batch_send && hr.isSupport() && localStorage.length < 100
        ? (dr.log(i), dr.batchSend.add(a.data), !1)
        : ('item_set' === i.type || 'item_delete' === i.type
            ? this.prepareServerUrl(a)
            : dn.stage.process('beforeSend', a),
          void dr.log(i))
    )
  }),
    (fn.prepareServerUrl = function (e) {
      if ('object' == typeof e.config && e.config.server_url)
        this.sendCall(e, e.config.server_url, e.callback)
      else if (v(dr.para.server_url) && dr.para.server_url.length)
        for (var t = 0; t < dr.para.server_url.length; t++) this.sendCall(e, dr.para.server_url[t])
      else
        'string' == typeof dr.para.server_url && '' !== dr.para.server_url
          ? this.sendCall(e, dr.para.server_url, e.callback)
          : dr.log(
              '\u5f53\u524d server_url \u4e3a\u7a7a\u6216\u4e0d\u6b63\u786e\uff0c\u53ea\u5728\u63a7\u5236\u53f0\u6253\u5370\u65e5\u5fd7\uff0cnetwork \u4e2d\u4e0d\u4f1a\u53d1\u6570\u636e\uff0c\u8bf7\u914d\u7f6e\u6b63\u786e\u7684 server_url\uff01'
            )
    }),
    (fn.sendCall = function (e, t, n) {
      var i = { server_url: t, data: JSON.stringify(e.data), callback: n, config: e.config }
      r(dr.para.jsapp) && !dr.para.jsapp.isOnline && 'function' == typeof dr.para.jsapp.setData
        ? (delete i.callback, (i = JSON.stringify(i)), dr.para.jsapp.setData(i))
        : this.realtimeSend(i)
    }),
    (fn.realtimeSend = function (e) {
      var t = Ft(e)
      t.start()
    })
  var _n = [
  ...
  ;(Gt.prototype.process = function (e, t) {
    ...
    (Gt.prototype.registerStageImplementation = function (t) {
      t &&
        t.init &&
        e(t.init) &&
        (t.init(this), t.interceptor && this.registerInterceptor(t.interceptor))
    }),
    (Gt.prototype.registerInterceptor = function (t) {
      if (t)
        for (var n in t) {
          var i = t[n]
          if (i && r(i) && e(i.entry)) {
  ...
  var hn = { addCustomProps: null, formatData: null },
    gn = new Gt(hn),
    mn = { beforeSend: 'send', send: 'afterSend', afterSend: null },
    vn = new Gt(mn),
    yn = { getUtmData: null },
    bn = new Gt(yn),
    wn = {
    ...
    kn = { init: function () {}, addCustomProps: function () {} },
    $n = {
      add: function (e) {
        dr.para.batch_send = !1
        var t = je(e.properties)
        dr.sendState.prepareServerUrl({ data: e, config: t })
      }
    }
  for (var Pn in nn) dr[Pn] = nn[Pn]
  return (
    (dr.modules = {}),
    _r.setup(Ne),
    (dr._ = $(xr, on)),
    (dr.sendState = fn),
    (dr.events = new dr._.EventEmitterSa()),
    (dr.store = Kr),
    (dr.heatmap = Yr),
    (dr.bridge = Sn),
    (dr.JSBridge = pr),
    ...
    (dr.init = function (e) {
      return (
        !(dr.readyState && dr.readyState.state && dr.readyState.state >= 2) &&
        ((e = e || {}),
        (e.batch_send = !1),
        r(e.heatmap) && (e.heatmap.get_vtrack_config = !1),
        dr.setInitVar(),
        dr.readyState.setState(2),
        dr.initPara(e),
        Xt(),
        void dr.iOSWebClickPolyfill())
      )
    }),
    Wt(),
    dr
